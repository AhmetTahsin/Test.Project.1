!(function (e, t) {
                        ...
                        r && p(r)
                            ...
                            : null == (o = r)
                                ...
                                : {}.toString
                                    ...
                                    .match(/\s([a-z]+)/i)[1]
                                    .toLowerCase();
                if (!RegExp(s).test(a)) throw Error(e.toUpperCase() + ': Option "' + n + '" provided type "' + a + '" but expected type "' + s + '".');
            });
        },
        m = function (e) {
            if (!e) return !1;
                        ...
                        ? ((p = e),
                            ...
                            function e(t) {
                                for (var i = p.querySelectorAll(h), n = t.target; n && n !== this; n = n.parentNode)
                                    for (var o = i.length; o--;) if (i[o] === n) return (t.delegateTarget = n), e.oneOff && $.off(p, t.type, f), f.apply(n, [t]);
                                return null;
                            })
                        : ((m = e),
                            (g = i),
                            function e(t) {
                                return (t.delegateTarget = m), e.oneOff && $.off(m, t.type, g), g.apply(m, [t]);
                            });
                (y.delegationSelector = r ? i : null), (y.originalHandler = a), (y.oneOff = o), (y.uidEvent = v), (d[v] = y), e.addEventListener(l, y, r);
            }
        }
    }
    ...
    var $ = {
                    ...
                    d &&
                        Object.keys(c).forEach(function (i) {
                            ...
                            (n = e),
                                ...
                                (s = i),
                                (r = t.slice(1)),
                                Object.keys((a = o[s] || {})).forEach(function (e) {
                                    if (e.includes(r)) {
                                        var t = a[e];
                                        M(n, o, s, t.originalHandler, t.delegationSelector);
                                    }
                                });
                        });
                    var u = c[a] || {};
        ...
        trigger: function (e, t, i) {
            ...
            var n,
                ...
                u = null;
            return (
                r && o && ((n = o.Event(t, i)), o(e).trigger(n), (l = !n.isPropagationStopped()), (c = !n.isImmediatePropagationStopped()), (d = n.isDefaultPrevented())),
    ...
    $.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', q.handleDismiss(new q())),
        b(function () {
            var e = y();
            if (e) {
                var t = e.fn[B];
        ...
        getDataAttributes: function (e) {
            ...
            return (
                Object.keys(e.dataset)
                    ...
                    .forEach(function (i) {
                        var n = i.replace(/^bs/, "");
                        t[(n = n.charAt(0).toLowerCase() + n.slice(1, n.length))] = H(e.dataset[i]);
                    }),
                t
            );
        },
                        ...
                        this._pointerEvent
                            ...
                            : ($.on(this._element, "touchstart.bs.carousel", function (e) {
                                ...
                                $.on(this._element, "touchmove.bs.carousel", function (t) {
                                    var i;
                                    (i = t).touches && i.touches.length > 1 ? (e.touchDeltaX = 0) : (e.touchDeltaX = i.touches[0].clientX - e.touchStartX);
                                }),
    ...
    function xe(e) {
        ...
        return i && "body" === ce(i) && "static" === ve(i).position
            ...
            : i ||
            (function (e) {
                for (var t = _e(e); pe(t) && 0 > ["html", "body"].indexOf(ce(t));) {
                    var i = ve(t);
    ...
    function Ee(e) {
        var t,
            ...
            u = e.gpuAcceleration,
            p = e.adaptive,
            h = ((i = (t = c).x), (n = t.y), { x: Math.round(i * (o = window.devicePixelRatio || 1)) / o || 0, y: Math.round(n * o) / o || 0 }),
            f = h.x,
            m = h.y,
            g = c.hasOwnProperty("x"),
        ...
        if (p) {
            var w = xe(r);
            w === de(r) && (w = be(r)), l === te && ((b = ie), (m -= w.clientHeight - a.height), (m *= u ? 1 : -1)), l === oe && ((y = ne), (f -= w.clientWidth - a.width), (f *= u ? 1 : -1));
        }
        var x,
            k = Object.assign({ position: d }, p && Pe);
        return u
            ? Object.assign(
                Object.assign({}, k),
                {},
                (((x = {})[b] = v ? "0" : ""), (x[y] = g ? "0" : ""), (x.transform = 2 > (_.devicePixelRatio || 1) ? "translate(" + f + "px, " + m + "px)" : "translate3d(" + f + "px, " + m + "px, 0)"), x)
            )
            : Object.assign(Object.assign({}, k), {}, (((s = {})[b] = v ? m + "px" : ""), (s[y] = g ? f + "px" : ""), (s.transform = ""), s));
    }
    var Oe = {
        name: "computeStyles",
        enabled: !0,
        ...
        fn: function (e) {
            var t = e.state,
                ...
                s = i.adaptive,
                r = void 0 === s || s,
                a = { placement: fe(t.placement), popper: t.elements.popper, popperRect: t.rects.popper, gpuAcceleration: o };
            null != t.modifiersData.popperOffsets &&
                (t.styles.popper = Object.assign(Object.assign({}, t.styles.popper), Ee(Object.assign(Object.assign({}, a), {}, { offsets: t.modifiersData.popperOffsets, position: t.options.strategy, adaptive: r })))),
    ...
    function Ne(e, t) {
        var i, n, o, s, r, a, l, c, d, u, p, h, f, m, g, v, y, b;
        return "viewport" === t
            ? He(
                ((n = de((i = e))),
                    (o = be(i)),
                    ...
                    (l = 0),
                    (c = 0),
                    s && ((r = s.width), (a = s.height), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || ((l = s.offsetLeft), (c = s.offsetTop))),
                    { width: r, height: a, x: l + Be(i), y: c })
            )
            : pe(t)
                ? (((u = $e((d = t))).top = u.top + d.clientTop),
                    (u.left = u.left + d.clientLeft),
                    (u.bottom = u.top + d.clientHeight),
                    (u.right = u.left + d.clientWidth),
                    (u.width = d.clientWidth),
                ...
                : He(
                    ((p = be(e)),
                        (h = be(p)),
                        (f = Re(p)),
                        (m = p.ownerDocument.body),
                        (g = Math.max(h.scrollWidth, h.clientWidth, m ? m.scrollWidth : 0, m ? m.clientWidth : 0)),
                        (v = Math.max(h.scrollHeight, h.clientHeight, m ? m.scrollHeight : 0, m ? m.clientHeight : 0)),
                        (y = -f.scrollLeft + Be(p)),
                        (b = -f.scrollTop),
                        "rtl" === ve(m || h).direction && (y += Math.max(h.clientWidth, m ? m.clientWidth : 0) - g),
                        { width: g, height: v, x: y, y: b })
                );
    }
    function We(e) {
        return e.split("-")[1];
    ...
    function Ue(e, t) {
        ...
        var i,
            ...
            f = u.boundary,
            m = void 0 === f ? "clippingParents" : f,
            g = u.rootBoundary,
            v = void 0 === g ? "viewport" : g,
            y = u.elementContext,
            b = void 0 === y ? "popper" : y,
            _ = u.altBoundary,
            w = void 0 !== _ && _,
            x = u.padding,
            k = void 0 === x ? 0 : x,
            T = Se("number" != typeof k ? k : Ce(k, se)),
            S = "popper" === b ? "reference" : "popper",
            C = e.elements.reference,
            j = e.rects.popper,
            P = e.elements[w ? S : b],
            E =
                ((i = ue(P) ? P : P.contextElement || be(e.elements.popper)),
                    (o = v),
                    (c = (l = [].concat(
                        "clippingParents" === (n = m)
                            ? ((s = i),
                                (r = Fe(_e(s))),
                                (a = ["absolute", "fixed"].indexOf(ve(s).position) >= 0 && pe(s) ? xe(s) : s),
                                ue(a)
                                    ? r.filter(function (e) {
                                        return ue(e) && ge(e, a) && "body" !== ce(e);
                                    })
                                    : [])
                            : [].concat(n),
                        [o]
                    ...
                    }, Ne(i, c))).width = d.right - d.left),
                    (d.height = d.bottom - d.top),
                    (d.x = d.left),
                    (d.y = d.top),
                    d),
            O = $e(C),
            A = Ge({ reference: O, element: j, strategy: "absolute", placement: h }),
            z = He(Object.assign(Object.assign({}, j), A)),
            I = "popper" === b ? z : O,
            L = { top: E.top - I.top + T.top, bottom: I.bottom - E.bottom + T.bottom, left: E.left - I.left + T.left, right: I.right - E.right + T.right },
            ...
            if (!t.modifiersData[n]._skip) {
                for (
                    ...
                    b = [g].concat(y).reduce(function (e, i) {
                        var n, o, s, r, a, l, p, h, g, v, y, b, _;
                        return e.concat(
                            "auto" === fe(i)
                                ? ((n = t),
                                    (s = (o = { placement: i, boundary: d, rootBoundary: u, padding: c, flipVariations: f, allowedAutoPlacements: m }).placement),
                                    (r = o.boundary),
                                    (a = o.rootBoundary),
                                    (l = o.padding),
                                    (p = o.flipVariations),
                                    (g = void 0 === (h = o.allowedAutoPlacements) ? ae : h),
                                    0 ===
                                    (b = (y = (v = We(s))
                                        ? p
                                            ? re
                                    ...
                                    Object.keys(
                                        (_ = b.reduce(function (e, t) {
                                            return (e[t] = Ue(n, { placement: t, boundary: r, rootBoundary: a, padding: l })[fe(t)]), e;
                                        }, {}))
                                    ).sort(function (e, t) {
                                        return _[e] - _[t];
                                    }))
                    ...
                    var C = b[S],
                        ...
                        E = [te, ie].indexOf(j) >= 0,
                        O = E ? "width" : "height",
                        A = Ue(t, { placement: C, boundary: d, rootBoundary: u, altBoundary: p, padding: c }),
                        z = E ? (P ? ne : oe) : P ? ie : te;
                    _[O] > w[O] && (z = Le(z));
                    var I = Le(z),
                        L = [];
                        ...
                        return (
                            (e[i] =
                                ((n = i),
                                    (o = t.rects),
                                    (r = s),
                                    (l = [oe, te].indexOf((a = fe(n))) >= 0 ? -1 : 1),
                                    (d = (d = (c = "function" == typeof r ? r(Object.assign(Object.assign({}, o), {}, { placement: n })) : r)[0]) || 0),
                                    (u = ((u = c[1]) || 0) * l),
                                    [oe, ne].indexOf(a) >= 0 ? { x: u, y: d } : { x: d, y: u })),
                            e
                        );
                    }, {}),
                    a = r[t.placement],
    ...
    function et(e, t, i) {
        ...
        return (
            (a || (!a && !i)) &&
            (("body" !== ce(t) || qe(s)) && (l = (n = t) !== de(n) && pe(n) ? { scrollLeft: (o = n).scrollLeft, scrollTop: o.scrollTop } : Re(n)), pe(t) ? (((c = $e(t)).x += t.clientLeft), (c.y += t.clientTop)) : s && (c.x = Be(s))),
            ...
            var o,
                ...
                d = {
                    ...
                    setOptions: function (i) {
                        u(), (a.options = Object.assign(Object.assign(Object.assign({}, s), a.options), i)), (a.scrollParents = { reference: ue(e) ? Fe(e) : e.contextElement ? Fe(e.contextElement) : [], popper: Fe(t) });
                        var o,
                            r,
                            c,
                            p,
                            ...
                            m =
                                ((o = Object.keys(
                                    (f = [].concat(n, a.options.modifiers).reduce(function (e, t) {
                                        var i = e[t.name];
                                        return (
                                            (e[t.name] = i
    ...
    var ot = nt(),
        ...
        lt = "dropdown",
        ct = RegExp("ArrowUp|ArrowDown|Escape"),
                ...
                (s.show = function () {
                    if (!(this._element.disabled || this._element.classList.contains("disabled") || this._menu.classList.contains("show"))) {
                        ...
                        if (!$.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
                            if (!this._inNavbar) {
                                if (void 0 === at) throw TypeError("Bootstrap's dropdowns require Popper (https://popper.js.org)");
                                var i,
                                    n = this._element;
                                "parent" === this._config.reference ? (n = e) : p(this._config.reference) && ((n = this._config.reference), void 0 !== this._config.reference.jquery && (n = this._config.reference[0])),
                                    (this._popper = rt(n, this._menu, this._getPopperConfig()));
                            }
                        ...
                        for (var t = G.find('[data-bs-toggle="dropdown"]'), i = 0, n = t.length; i < n; i++) {
                            ...
                            if ((e && "click" === e.type && (a.clickEvent = e), r)) {
                                ...
                                t[i].classList.contains("show") &&
                                    !((e && (("click" === e.type && /input|textarea/i.test(e.target.tagName)) || ("keyup" === e.type && "Tab" === e.key)) && c.contains(e.target)) || $.trigger(s, "hide.bs.dropdown", a).defaultPrevented) &&
                                    ("ontouchstart" in document.documentElement &&
    ...
    $.on(document, "keydown.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', yt.dataApiKeydownHandler),
        $.on(document, "keydown.bs.dropdown.data-api", ".dropdown-menu", yt.dataApiKeydownHandler),
            ...
            return (
                ...
                (s.show = function (e) {
                    ...
                    if (!this._isShown && !this._isTransitioning) {
                        ...
                        var i = $.trigger(this._element, "show.bs.modal", { relatedTarget: e });
                        this._isShown ||
                            i.defaultPrevented ||
                            ((this._isShown = !0),
                                ...
                                $.on(this._element, "click.dismiss.bs.modal", '[data-bs-dismiss="modal"]', function (e) {
                                    return t.hide(e);
                                }),
                ...
                (s._showElement = function (e) {
                    ...
                    var o = function () {
                        t._config.focus && t._element.focus(), (t._isTransitioning = !1), $.trigger(t._element, "shown.bs.modal", { relatedTarget: e });
                    };
                    if (i) {
    ...
    var Ct = "tooltip",
        ...
        Ot = { AUTO: "auto", TOP: "top", RIGHT: _ ? "left" : "right", BOTTOM: "bottom", LEFT: _ ? "right" : "left" },
        At = {
            animation: !0,
        ...
        It = (function (e) {
            function o(t, i) {
                var n;
                if (void 0 === at) throw TypeError("Bootstrap's tooltips require Popper (https://popper.js.org)");
            ...
            return (
                        ...
                        if (!$.trigger(this._element, this.constructor.Event.HIDE).defaultPrevented) {
                            if (
                                (i.classList.remove("show"),
                                    "ontouchstart" in document.documentElement &&
                                    (t = []).concat.apply(t, document.body.children).forEach(function (e) {
                ...
                (s._setListeners = function () {
                    ...
                    this.config.trigger.split(" ").forEach(function (t) {
                        if ("click" === t)
                            $.on(e._element, e.constructor.Event.CLICK, e.config.selector, function (t) {
                                return e.toggle(t);
                            });
                        else if ("manual" !== t) {
    ...
    var Lt = "popover",
        Dt = RegExp("(^|\\s)bs-popover\\S+", "g"),
        Mt = i({}, It.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' }),
        ...
        return (
            (o.show = function () {
                ...
                if (!((this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains("active")) || this._element.classList.contains("disabled"))) {
                    ...
                    var s = null;
                    if ((t && (s = $.trigger(t, "hide.bs.tab", { relatedTarget: this._element })), !($.trigger(this._element, "show.bs.tab", { relatedTarget: t }).defaultPrevented || (null !== s && s.defaultPrevented)))) {
                        this._activate(this._element, n);
                        var r = function () {
                            $.trigger(t, "hidden.bs.tab", { relatedTarget: e._element }), $.trigger(e._element, "shown.bs.tab", { relatedTarget: t });
                        };
    ...
    return (
        ...
        { Alert: q, Button: F, Carousel: K, Collapse: ee, Dropdown: yt, Modal: wt, Popover: Bt, ScrollSpy: Nt, Tab: Wt, Toast: Yt, Tooltip: It }
    );
}),
    (function (e, t) {
    ...
    (function (e, t) {
        ...
        function n(e, t, o) {
            ...
            return (
                ...
                c
                    ? ((this.elements = Array.isArray((s = c)) ? s : "object" == typeof s && "number" == typeof s.length ? l.call(s) : [s]),
        ...
        return function n(a) {
            if (
                ...
                var f = c.paddingLeft + c.paddingRight,
                    ...
                    _ = d && i,
                    w = e(l.width);
                !1 !== w && (c.width = w + (_ ? 0 : f + y));
                var x = e(l.height);
                return !1 !== x && (c.height = x + (_ ? 0 : m + b)), (c.innerWidth = c.width - (f + y)), (c.innerHeight = c.height - (m + b)), (c.outerWidth = c.width + g), (c.outerHeight = c.height + v), c;
            }
        };
    }),
    (function (e, t) {
                            ...
                            function (i, n) {
                                for (var o = 0; o < e.length; o++) {
                                    var s = e[o],
                                        r = i.sortData[s],
                                        a = n.sortData[s];
                                    if (a < r || r < a) return (a < r ? 1 : -1) * ((void 0 !== t[s] ? t[s] : t) ? 1 : -1);
                                }
                                return 0;
                            });
    ...
    (function (e) {
        ...
        var t,
            ...
            k = function (t, n) {
                i.ev.triggerHandler(h + t, n), i.st.callbacks && ((t = t.charAt(0).toLowerCase() + t.slice(1)), i.st.callbacks[t] && i.st.callbacks[t].apply(i, e.isArray(n) ? n : [n]));
            },
            T = function (t) {
                return (t === a && i.currTemplate.closeBtn) || ((i.currTemplate.closeBtn = e(i.st.closeMarkup.replace("%title%", i.st.tClose))), (a = t)), i.currTemplate.closeBtn;
            },
            S = function () {
                e.magnificPopup.instance || ((i = new y()).init(), (e.magnificPopup.instance = i));
            };
        (y.prototype = {
            constructor: y,
            init: function () {
                ...
                (i.isLowIE = i.isIE8 = document.all && !document.addEventListener),
                    (i.isAndroid = /android/gi.test(t)),
                    (i.isIOS = /iphone|ipad|ipod/gi.test(t)),
                    ...
                    (i.probablyMobile = i.isAndroid || i.isIOS || /(Opera Mini)|Kindle|webOS|BlackBerry|(Opera Mobi)|(Windows Phone)|IEMobile/i.test(navigator.userAgent)),
                    (o = e(document)),
                    (i.popupsCache = {});
            },
            open: function (t) {
                var n;
                if (!1 === t.isObj) {
                    (i.items = t.items.toArray()), (i.index = 0);
                    var s,
                        a = t.items;
                    for (n = 0; n < a.length; n++)
                        if (((s = a[n]).parsed && (s = s.el[0]), s === t.el[0])) {
                            i.index = n;
                            break;
                        }
                } else (i.items = e.isArray(t.items) ? t.items : [t.items]), (i.index = t.index || 0);
                if (!i.isOpen) {
                    (i.types = []),
                        (r = ""),
                        t.mainEl && t.mainEl.length ? (i.ev = t.mainEl.eq(0)) : (i.ev = o),
                        t.key ? (i.popupsCache[t.key] || (i.popupsCache[t.key] = {}), (i.currTemplate = i.popupsCache[t.key])) : (i.currTemplate = {}),
                        (i.st = e.extend(!0, {}, e.magnificPopup.defaults, t)),
                        (i.fixedContentPos = "auto" === i.st.fixedContentPos ? !i.probablyMobile : i.st.fixedContentPos),
                        i.st.modal && ((i.st.closeOnContentClick = !1), (i.st.closeOnBgClick = !1), (i.st.showCloseBtn = !1), (i.st.enableEscapeKey = !1)),
                        i.bgOverlay ||
                        ((i.bgOverlay = x("bg").on("click" + f, function () {
                            i.close();
                        })),
                            (i.wrap = x("wrap")
                                .attr("tabindex", -1)
                                .on("click" + f, function (e) {
                                    i._checkIfClose(e.target) && i.close();
                                })),
                            (i.container = x("container", i.wrap))),
                        (i.contentContainer = x("content")),
                        i.st.preloader && (i.preloader = x("preloader", i.container, i.st.tLoading));
                    var l = e.magnificPopup.modules;
                    for (n = 0; n < l.length; n++) {
                        var c = l[n];
                        i["init" + (c = c.charAt(0).toUpperCase() + c.slice(1))].call(i);
                    }
                    k("BeforeOpen"),
                        i.st.showCloseBtn &&
                        (i.st.closeBtnInside
                            ? (w(d, function (e, t, i, n) {
                                ...
                                (r += " mfp-close-btn-in"))
                            : i.wrap.append(T())),
                        i.st.alignTop && (r += " mfp-align-top"),
                        i.fixedContentPos ? i.wrap.css({ overflow: i.st.overflowY, overflowX: "hidden", overflowY: i.st.overflowY }) : i.wrap.css({ top: _.scrollTop(), position: "absolute" }),
                        (!1 !== i.st.fixedBgPos && ("auto" !== i.st.fixedBgPos || i.fixedContentPos)) || i.bgOverlay.css({ height: o.height(), position: "absolute" }),
                        ...
                        i.st.closeOnContentClick || (r += " mfp-auto-cursor"),
                        r && i.wrap.addClass(r);
                    var p = (i.wH = _.height()),
                        h = {};
                    if (i.fixedContentPos && i._hasScrollBar(p)) {
                        var g = i._getScrollbarSize();
                        g && (h.marginRight = g);
                    }
                    i.fixedContentPos && (i.isIE7 ? e("body, html").css("overflow", "hidden") : (h.overflow = "hidden"));
                    var v = i.st.mainClass;
                    return (
                        i.isIE7 && (v += " mfp-ie7"),
                        v && i._addClassToMFP(v),
                        i.updateItemHTML(),
                        k("BuildControls"),
                        e("html").css(h),
                        i.bgOverlay.add(i.wrap).prependTo(i.st.prependTo || e(document.body)),
                        (i._lastFocusedEl = document.activeElement),
                        setTimeout(function () {
                            i.content ? (i._addClassToMFP(m), i._setFocus()) : i.bgOverlay.addClass(m), o.on("focusin" + f, i._onFocusIn);
                        }, 16),
                        (i.isOpen = !0),
                        i.updateSize(p),
                        k(u),
            ...
            _close: function () {
                k(l);
                var t = g + " " + m + " ";
                if ((i.bgOverlay.detach(), i.wrap.detach(), i.container.empty(), i.st.mainClass && (t += i.st.mainClass + " "), i._removeClassFromMFP(t), i.fixedContentPos)) {
                    var n = { marginRight: "" };
                    i.isIE7 ? e("body, html").css("overflow", "") : (n.overflow = ""), e("html").css(n);
                }
                o.off("keyup.mfp focusin" + f),
                    ...
                    !i.st.showCloseBtn || (i.st.closeBtnInside && !0 !== i.currTemplate[i.currItem.type]) || (i.currTemplate.closeBtn && i.currTemplate.closeBtn.detach()),
                    i.st.autoFocusLast && i._lastFocusedEl && e(i._lastFocusedEl).focus(),
                    (i.currItem = null),
                    (i.content = null),
                    (i.currTemplate = null),
                    (i.prevHeight = 0),
            ...
            updateSize: function (e) {
                if (i.isIOS) {
                    ...
                    i.wrap.css("height", n), (i.wH = n);
                } else i.wH = e || _.height();
                i.fixedContentPos || i.wrap.css("height", i.wH), k("Resize");
            },
            updateItemHTML: function () {
                var t = i.items[i.index];
                i.contentContainer.detach(), i.content && i.content.detach(), t.parsed || (t = i.parseEl(i.index));
                var n = t.type;
                if ((k("BeforeChange", [i.currItem ? i.currItem.type : "", n]), (i.currItem = t), !i.currTemplate[n])) {
                    var o = !!i.st[n] && i.st[n].markup;
                    k("FirstMarkupParse", o), (i.currTemplate[n] = !o || e(o));
                }
                s && s !== t.type && i.container.removeClass("mfp-" + s + "-holder");
                var r = i["get" + n.charAt(0).toUpperCase() + n.slice(1)](t, i.currTemplate[n]);
                i.appendContent(r, n), (t.preloaded = !0), k(p, t), (s = t.type), i.container.prepend(i.contentContainer), k("AfterChange");
            },
            appendContent: function (e, t) {
                (i.content = e),
                    e ? (i.st.showCloseBtn && i.st.closeBtnInside && !0 === i.currTemplate[t] ? i.content.find(".mfp-close").length || i.content.append(T()) : (i.content = e)) : (i.content = ""),
                    k("BeforeAppend"),
                    i.container.addClass("mfp-" + t + "-holder"),
            ...
            parseEl: function (t) {
                ...
                if ((o.tagName ? (o = { el: e(o) }) : ((n = o.type), (o = { data: o, src: o.src })), o.el)) {
                    for (var s = i.types, r = 0; r < s.length; r++)
                ...
                return (o.type = n || i.st.type || "inline"), (o.index = t), (o.parsed = !0), (i.items[t] = o), k("ElementParse", o), i.items[t];
            },
            addGroup: function (e, t) {
                var n = function (n) {
                    (n.mfpEl = this), i._openClick(n, e, t);
                };
                t || (t = {});
                var o = "click.magnificPopup";
                (t.mainEl = e), t.items ? ((t.isObj = !0), e.off(o).on(o, n)) : ((t.isObj = !1), t.delegate ? e.off(o).on(o, t.delegate, n) : ((t.items = e), e.off(o).on(o, n)));
            },
            _openClick: function (t, n, o) {
                if ((void 0 !== o.midClick ? o.midClick : e.magnificPopup.defaults.midClick) || !(2 === t.which || t.ctrlKey || t.metaKey || t.altKey || t.shiftKey)) {
                    var s = void 0 !== o.disableOn ? o.disableOn : e.magnificPopup.defaults.disableOn;
                    if (s)
                        if (e.isFunction(s)) {
                            if (!s.call(i)) return !0;
                        } else if (_.width() < s) return !0;
                    t.type && (t.preventDefault(), i.isOpen && t.stopPropagation()), (o.el = e(t.mfpEl)), o.delegate && (o.items = n.find(o.delegate)), i.open(o);
                }
            },
            updateStatus: function (e, t) {
                if (i.preloader) {
                    n !== e && i.container.removeClass("mfp-s-" + n), t || "loading" !== e || (t = i.st.tLoading);
                    var o = { status: e, text: t };
                    k("UpdateStatus", o),
                        (e = o.status),
                        (t = o.text),
                        i.preloader.html(t),
                        i.preloader.find("a").on("click", function (e) {
                            e.stopImmediatePropagation();
                        }),
                        i.container.addClass("mfp-s-" + e),
                        (n = e);
                }
            },
            _checkIfClose: function (t) {
                if (!e(t).hasClass(v)) {
                    var n = i.st.closeOnContentClick,
                        o = i.st.closeOnBgClick;
                    if ((n && o) || !i.content || e(t).hasClass("mfp-close") || (i.preloader && t === i.preloader[0])) return !0;
                    if (t === i.content[0] || e.contains(i.content[0], t)) {
                        if (n) return !0;
            ...
            _addClassToMFP: function (e) {
                i.bgOverlay.addClass(e), i.wrap.addClass(e);
            },
            _removeClassFromMFP: function (e) {
                this.bgOverlay.removeClass(e), i.wrap.removeClass(e);
            },
            _hasScrollBar: function (e) {
                return (i.isIE7 ? o.height() : document.body.scrollHeight) > (e || _.height());
            },
            _setFocus: function () {
                (i.st.focus ? i.content.find(i.st.focus).eq(0) : i.wrap).focus();
            },
            _onFocusIn: function (t) {
                return t.target === i.wrap[0] || e.contains(i.wrap[0], t.target) ? void 0 : (i._setFocus(), !1);
            },
            ...
            _getScrollbarSize: function () {
                if (void 0 === i.scrollbarSize) {
                    var e = document.createElement("div");
                    (e.style.cssText = "width: 99px; height: 99px; overflow: scroll; position: absolute; top: -9999px;"), document.body.appendChild(e), (i.scrollbarSize = e.offsetWidth - e.clientWidth), document.body.removeChild(e);
                }
            ...
            (e.fn.magnificPopup = function (t) {
                ...
                if ("string" == typeof t)
                    if ("open" === t) {
                        ...
                        s.items ? (o = s.items[r]) : ((o = n), s.delegate && (o = o.find(s.delegate)), (o = o.eq(r))), i._openClick({ mfpEl: o }, n, s);
                    } else i.isOpen && i[t].apply(i, Array.prototype.slice.call(arguments, 1));
                else (t = e.extend(!0, {}, t)), b ? n.data("magnificPopup", t) : (n[0].magnificPopup = t), i.addGroup(n, t);
                return n;
            });
        var C,
            j,
            ...
            E = "inline",
            O = function () {
                P && (j.after(P.addClass(C)).detach(), (P = null));
            };
                ...
                getInline: function (t, n) {
                    if ((O(), t.src)) {
                        ...
                        if (s.length) {
                            ...
                            r && r.tagName && (j || ((j = x((C = o.hiddenClass))), (C = "mfp-" + C)), (P = s.after(j).detach().removeClass(C))), i.updateStatus("ready");
                        } else i.updateStatus("error", o.tNotFound), (s = e("<div>"));
                        return (t.inlineElement = s), s;
                    }
                    return i.updateStatus("ready"), i._parseMarkup(n, {}, t), n;
                },
            },
        });
        var A,
        ...
        e.magnificPopup.registerModule(z, {
            ...
            proto: {
                initAjax: function () {
                    i.types.push(z), (A = i.st.ajax.cursor), w(l + "." + z, L), w("BeforeChange." + z, L);
                },
                getAjax: function (t) {
                    A && e(document.body).addClass(A), i.updateStatus("loading");
                    var n = e.extend(
                        {
                            url: t.src,
                            ...
                            error: function () {
                                I(), (t.finished = t.loadError = !0), i.updateStatus("error", i.st.ajax.tError.replace("%url%", t.src));
                            },
                        },
                        i.st.ajax.settings
                    );
                    return (i.req = e.ajax(n)), "";
                },
            },
        });
        var D,
            M = function (t) {
                ...
                var n = i.st.image.titleSrc;
                if (n) {
                    if (e.isFunction(n)) return n.call(i, t);
        ...
        e.magnificPopup.registerModule("image", {
            ...
            proto: {
                initImage: function () {
                    ...
                    i.types.push("image"),
                        w(u + n, function () {
                            "image" === i.currItem.type && t.cursor && e(document.body).addClass(t.cursor);
                        }),
                        w(l + n, function () {
                            t.cursor && e(document.body).removeClass(t.cursor), _.off("resize" + f);
                        }),
                        w("Resize" + n, i.resizeImage),
                        i.isLowIE && w("AfterChange", i.resizeImage);
                },
                resizeImage: function () {
                    var e = i.currItem;
                    if (e && e.img && i.st.image.verticalFit) {
                        var t = 0;
                        i.isLowIE && (t = parseInt(e.img.css("padding-top"), 10) + parseInt(e.img.css("padding-bottom"), 10)), e.img.css("max-height", i.wH - t);
                    }
                },
                _onImageHasSize: function (e) {
                    e.img && ((e.hasSize = !0), D && clearInterval(D), (e.isCheckingImgSize = !1), k("ImageHasSize", e), e.imgHidden && (i.content && i.content.removeClass("mfp-loading"), (e.imgHidden = !1)));
                },
                        ...
                        o = function (s) {
                            D && clearInterval(D),
                                (D = setInterval(function () {
                                    return n.naturalWidth > 0 ? void i._onImageHasSize(e) : (t > 200 && clearInterval(D), void (3 == ++t ? o(10) : 40 === t ? o(50) : 100 === t && o(500)));
                                }, s));
                        };
                    o(1);
                },
                getImage: function (t, n) {
                    var o = 0,
                        s = function () {
                            t &&
                                (t.img[0].complete
                                    ? (t.img.off(".mfploader"), t === i.currItem && (i._onImageHasSize(t), i.updateStatus("ready")), (t.hasSize = !0), (t.loaded = !0), k("ImageLoadComplete"))
                                    : 200 > ++o
                                        ? setTimeout(s, 100)
                                        : r());
                        },
                        r = function () {
                            t && (t.img.off(".mfploader"), t === i.currItem && (i._onImageHasSize(t), i.updateStatus("error", a.tError.replace("%url%", t.src))), (t.hasSize = !0), (t.loaded = !0), (t.loadError = !0));
                        },
                        a = i.st.image,
                        l = n.find(".mfp-img");
                    if (l.length) {
                        ...
                        (c.className = "mfp-img"),
                            t.el && t.el.find("img").length && (c.alt = t.el.find("img").attr("alt")),
                            (t.img = e(c).on("load.mfploader", s).on("error.mfploader", r)),
                            (c.src = t.src),
                            l.is("img") && (t.img = t.img.clone()),
                            (c = t.img[0]).naturalWidth > 0 ? (t.hasSize = !0) : c.width || (t.hasSize = !1);
                    }
                    return (
                        i._parseMarkup(n, { title: M(t), img_replaceWith: t.img }, t),
                        i.resizeImage(),
                        t.hasSize
                            ? (D && clearInterval(D), t.loadError ? (n.addClass("mfp-loading"), i.updateStatus("error", a.tError.replace("%url%", t.src))) : (n.removeClass("mfp-loading"), i.updateStatus("ready")), n)
                            : (i.updateStatus("loading"), (t.loading = !0), t.hasSize || ((t.imgHidden = !0), n.addClass("mfp-loading"), i.findImageSize(t)), n)
                    );
                },
            },
        }),
                ...
                proto: {
                    initZoom: function () {
                        var e,
                            t = i.st.zoom,
                            n = ".zoom";
                        if (t.enabled && i.supportsTransition) {
                            var o,
                                s,
                                r = t.duration,
                                a = function (e) {
                            ...
                            w("BuildControls" + n, function () {
                                if (i._allowZoom()) {
                                    if ((clearTimeout(o), i.content.css("visibility", "hidden"), !(e = i._getItemToZoom()))) return void d();
                                    (s = a(e)).css(i._getOffset()),
                                        i.wrap.append(s),
                                        (o = setTimeout(function () {
                                            s.css(i._getOffset(!0)),
                                                (o = setTimeout(function () {
                                                    d(),
                                                        setTimeout(function () {
                                ...
                                w(c + n, function () {
                                    if (i._allowZoom()) {
                                        if ((clearTimeout(o), (i.st.removalDelay = r), !e)) {
                                            if (!(e = i._getItemToZoom())) return;
                                            s = a(e);
                                        }
                                        s.css(i._getOffset(!0)),
                                            i.wrap.append(s),
                                ...
                                w(l + n, function () {
                                    i._allowZoom() && (d(), s && s.remove(), (e = null));
                                });
                        }
                    },
                    _allowZoom: function () {
                    ...
                    _getOffset: function (n) {
                        var o,
                            s = (o = n ? i.currItem.img : i.st.zoom.opener(i.currItem.el || i.currItem)).offset(),
                            r = parseInt(o.css("padding-top"), 10),
                            a = parseInt(o.css("padding-bottom"), 10);
                        s.top -= e(window).scrollTop() - r;
                        var l = { width: o.width(), height: (b ? o.innerHeight() : o[0].offsetHeight) - a - r };
                        return (
                            void 0 === t && (t = void 0 !== document.createElement("p").style.MozTransform), t ? (l["-moz-transform"] = l.transform = "translate(" + s.left + "px," + s.top + "px)") : ((l.left = s.left), (l.top = s.top)), l
                        );
                    },
                },
            });
        var $ = "iframe",
            R = function (e) {
                if (i.currTemplate[$]) {
                    var t = i.currTemplate[$].find("iframe");
                    t.length && (e || (t[0].src = "//about:blank"), i.isIE8 && t.css("display", e ? "block" : "none"));
                }
            };
        e.magnificPopup.registerModule($, {
            ...
            proto: {
                ...
                getIframe: function (t, n) {
                    ...
                    var r = {};
                    return s.srcAction && (r[s.srcAction] = o), i._parseMarkup(n, r, t), i.updateStatus("ready"), n;
                },
            },
        });
        var B = function (e) {
                        ...
                        ((r += " mfp-gallery"),
                            w(u + n, function () {
                                t.navigateByImgClick &&
                                    i.wrap.on("click" + n, ".mfp-img", function () {
                            ...
                            w("UpdateStatus" + n, function (e, t) {
                                t.text && (t.text = q(t.text, i.currItem.index, i.items.length));
                            }),
                            w(d + n, function (e, n, o, s) {
                                var r = i.items.length;
                                o.counter = r > 1 ? q(t.tCounter, s.index, r) : "";
                            }),
                            w("BuildControls" + n, function () {
                                if (i.items.length > 1 && t.arrows && !i.arrowLeft) {
                                    var n = t.arrowMarkup,
                                        o = (i.arrowLeft = e(n.replace(/%title%/gi, t.tPrev).replace(/%dir%/gi, "left")).addClass(v)),
                                        s = (i.arrowRight = e(n.replace(/%title%/gi, t.tNext).replace(/%dir%/gi, "right")).addClass(v));
                                    o.click(function () {
                                        i.prev();
                                    }),
                                        s.click(function () {
                            ...
                            void w(l + n, function () {
                                o.off(n), i.wrap.off("click" + n), (i.arrowRight = i.arrowLeft = null);
                            }))
                    );
                },
                next: function () {
                    (i.direction = !0), (i.index = B(i.index + 1)), i.updateItemHTML();
                },
                prev: function () {
                    (i.direction = !1), (i.index = B(i.index - 1)), i.updateItemHTML();
                },
                goTo: function (e) {
                    (i.direction = e >= i.index), (i.index = e), i.updateItemHTML();
                },
                preloadNearbyImages: function () {
                    var e,
                        t = i.st.gallery.preload,
                        n = Math.min(t[0], i.items.length),
                        o = Math.min(t[1], i.items.length);
                    for (e = 1; e <= (i.direction ? o : n); e++) i._preloadItem(i.index + e);
                    for (e = 1; e <= (i.direction ? n : o); e++) i._preloadItem(i.index - e);
                },
                _preloadItem: function (t) {
                    if (((t = B(t)), !i.items[t].preloaded)) {
                        var n = i.items[t];
                        n.parsed || (n = i.parseEl(t)),
                            k("LazyLoad", n),
                            "image" === n.type &&
                ...
                initRetina: function () {
                    if (window.devicePixelRatio > 1) {
                        var e = i.st.retina,
                            t = e.ratio;
                        (t = isNaN(t) ? t() : t) > 1 &&
                            (w("ImageHasSize." + F, function (e, i) {
                                i.img.css({ "max-width": i.img[0].naturalWidth / t, width: "100%" });
                            }),
                                w("ElementParse." + F, function (i, n) {
    ...
    eval(
        (function (e, t, i, n, o, s) {
            ...
            for (; i--;) n[i] && (e = e.replace(RegExp("\\b" + o(i) + "\\b", "g"), n[i]));
            return e;
        })(
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    function h(e, t, s, r, a) {
        ...
        for (l = 0; l < x; l++)
            (c = (h = e[k]).a),
                ...
                (g = a
                    ? ((b = i[l]),
                        (w = (((_ = n[l]) + b) * t * 0.25) / (r ? 0.5 : o[l] || 0.5)),
                        d - ((f = d - (d - c) * (r ? 0.5 * t : 0 !== b ? w / b : 0)) + ((((m = d + (u - d) * (r ? 0.5 * t : 0 !== _ ? w / _ : 0)) - f) * ((3 * b) / (b + _) + 0.5)) / 4 || 0)))
                    : d - ((f = d - (d - c) * t * 0.5) + (m = d + (u - d) * t * 0.5)) / 2),
                (f += g),
                (m += g),
                (h.c = v = f),
                ...
                (h.ca = v - c),
                (h.ba = T - c),
                s ? ((y = p(c, T, v, d)), e.splice(k, 1, y[0], y[1], y[2], y[3]), (k += 4)) : k++,
                (T = m);
        ((h = e[k]).b = T), (h.c = T + 0.4 * (h.d - T)), (h.da = h.d - h.a), (h.ca = h.c - h.a), (h.ba = T - h.a), s && ((y = p(h.a, T, h.c, h.d)), e.splice(k, 1, y[0], y[1], y[2], y[3]));
    }
    function f(e, t, o, s) {
        var r,
            a,
            ...
            p,
            h = [];
        if (s) for (a = (e = [s].concat(e)).length; -1 < --a;) "string" == typeof (p = e[a][t]) && "=" === p.charAt(1) && (e[a][t] = s[t] + Number(p.charAt(0) + p.substr(2)));
        if ((r = e.length - 2) < 0) return (h[0] = new u(e[0][t], 0, 0, e[0][t])), h;
        for (a = 0; a < r; a++) (l = e[a][t]), (c = e[a + 1][t]), (h[a] = new u(l, 0, 0, c)), o && ((d = e[a + 2][t]), (i[a] = (i[a] || 0) + (c - l) * (c - l)), (n[a] = (n[a] || 0) + (d - c) * (d - c)));
        return (h[a] = new u(e[a][t], 0, 0, e[a + 1][t])), h;
    }
    function m(e, t, r, a, l, c) {
        var d,
            u,
            p,
            m,
        ...
        if (1 < e.length) {
            for (b = e[e.length - 1], y = !0, d = w.length; -1 < --d;)
                if (0.05 < Math.abs(x[(u = w[d])] - b[u])) {
                    y = !1;
                    break;
                }
            y && ((e = e.concat()), c && e.unshift(c), e.push(e[1]), (c = e[e.length - 3]));
        }
        for (i.length = n.length = o.length = 0, d = w.length; -1 < --d;) (s[(u = w[d])] = -1 !== l.indexOf("," + u + ",")), (_[u] = f(e, u, s[u], c));
        for (d = i.length; -1 < --d;) (i[d] = Math.sqrt(i[d])), (n[d] = Math.sqrt(n[d]));
        if (!a) {
            for (d = w.length; -1 < --d;) if (s[u]) for (v = (p = _[w[d]]).length - 1, m = 0; m < v; m++) (g = p[m + 1].da / n[m] + p[m].da / i[m] || 0), (o[m] = (o[m] || 0) + g * g);
            for (d = o.length; -1 < --d;) o[d] = Math.sqrt(o[d]);
        }
        for (d = w.length, m = r ? 4 : 1; -1 < --d;) h((p = _[(u = w[d])]), t, r, a, s[u]), y && (p.splice(0, m), p.splice(p.length - m, m));
        return _;
    }
    function g(e, t, i) {
    ...
    _gsScope._gsDefine(
            ...
            function s(e) {
                ...
                return function (e, c, d) {
                    ...
                    if (!w) {
                        ...
                        for (w = s[_] = [], u = r ? Math.min(b, _) * l - 0.5 : n % b, p = r ? (_ * l) / b - 0.5 : (n / b) | 0, y = 1 / (v = 0), g = 0; g < _; g++)
                            (h = (g % b) - u), (f = p - ((g / b) | 0)), (w[g] = m = a ? Math.abs("y" === a ? f : h) : Math.sqrt(h * h + f * f)), v < m && (v = m), m < y && (y = m);
            ...
            (r.version = "2.1.3"),
                ...
                (u.updateTo = function (e, t) {
                    ...
                    if (o._initted || r)
                        ...
                        } else if (((o._initted = !1), o._init(), 0 < o._time || r)) for (var l, c = 1 / (1 - s), d = o._firstPT; d;) (l = d.s + d.c), (d.c *= c), (d.s = l - d.c), (d = d._next);
                    return o;
                }),
                            ...
                            : e < a
                                ...
                                : ((m._totalTime = m._time = e),
                                    ...
                                    ((c = _ + m._repeatDelay),
                                        ...
                                        0 !== m._cycle && m._cycle === m._totalTime / c && y <= e && m._cycle--,
                                        ...
                                        ((m._time = _ - m._time),
                                            ...
                                            (m._yoyoEase ||
                                                (!0 !== f || m._initted
                                                    ? (m._yoyoEase = f = !0 === f ? m._ease : f instanceof Ease ? f : Ease.map[f])
                                                    : ((f = m.vars.ease), (m._yoyoEase = f = f ? (f instanceof Ease ? f : "function" == typeof f ? new Ease(f, m.vars.easeParams) : Ease.map[f] || i.defaultEase) : i.defaultEase))),
                                                (m.ratio = f ? 1 - f.getRatio((_ - m._time) / _) : 0))),
                                        m._time > _ ? (m._time = _) : m._time < 0 && (m._time = 0)),
                                    m._easeType && !f
                                        ? ((d = m._time / _),
                                            (1 === (u = m._easeType) || (3 === u && 0.5 <= d)) && (d = 1 - d),
                                            3 === u && (d *= 2),
                                            1 === (p = m._easePower) ? (d *= d) : 2 === p ? (d *= d * d) : 3 === p ? (d *= d * d * d) : 4 === p && (d *= d * d * d * d),
                                            (m.ratio = 1 === u ? 1 - d : 2 === u ? d : m._time / _ < 0.5 ? d / 2 : 1 - d / 2))
                ...
                (r.killChildTweensOf = function (e, t) {
                    if (null != e) {
                        var o,
                            ...
                            p,
                            h = l.tweenLookup;
                        if (("string" == typeof e && (e = i.selector(e) || e), c(e) && (e = n(e)), d(e))) for (u = e.length; -1 < --u;) r.killChildTweensOf(e[u], t);
                        else {
            ...
            function (e, t, i) {
                function n(e) {
                    ...
                    for (n in ((o._labels = {}), (o.autoRemoveChildren = !!s.autoRemoveChildren), (o.smoothChildTiming = !!s.smoothChildTiming), (o._sortChildren = !0), (o._onUpdate = s.onUpdate), s))
                        p((i = s[n])) && -1 !== i.join("").indexOf("{self}") && (s[n] = o._swapSelfInParams(i));
                ...
                return (
                    ...
                    (v.staggerTo = function (e, t, r, l, c, d, p, h) {
                        var f,
                            m,
                            g = new n({ onComplete: d, onCompleteParams: p, callbackScope: h, smoothChildTiming: this.smoothChildTiming }),
                            v = a(r.stagger || l),
                            y = r.startAt,
                            b = r.cycle;
                        for (
                            ...
                            (f = o(r)), y && ((f.startAt = o(y)), y.cycle && s(f.startAt, e, m)), b && (s(f, e, m), null != f.duration && ((t = f.duration), delete f.duration)), g.to(e[m], t, f, v(m, e[m], e));
                        return this.add(g, c);
                    }),
                    ...
                    (n.exportRoot = function (e, t) {
                        ...
                        var o,
                            ...
                            l = new n(e),
                            c = l._timeline;
                        for (null == t && (t = !0), c._remove(l, !0), l._startTime = 0, l._rawPrevTime = l._time = l._totalTime = c._time, r = c._first; r;)
                    ...
                    (v.add = function (o, s, r, a) {
                        ...
                        if (("number" != typeof s && (s = m._parseTimeOrLabel(s, 0, !0, o)), !(o instanceof e))) {
                            if (o instanceof Array || (o && o.push && p(o))) {
                                for (r = r || "normal", a = a || 0, l = s, c = o.length, d = 0; d < c; d++)
                    ...
                    (v._parseTimeOrLabel = function (t, i, n, o) {
                        ...
                        else if (o && (o instanceof Array || (o.push && p(o)))) for (r = o.length; -1 < --r;) o[r] instanceof e && o[r].timeline === this && this.remove(o[r]);
                    ...
                    (v.render = function (e, t, i) {
                        ...
                        if ((m !== p._time && (e += p._time - m), p._hasPause && !p._forcingPlayhead && !t)) {
                            if (m < e) for (n = p._first; n && n._startTime <= e && !c;) n._duration || "isPause" !== n.data || n.ratio || (0 === n._startTime && 0 === p._rawPrevTime) || (c = n), (n = n._next);
                            else for (n = p._last; n && n._startTime >= e && !c;) n._duration || ("isPause" === n.data && 0 < n._rawPrevTime && (c = n)), (n = n._prev);
                        ...
                        if (g - l <= e && 0 <= e)
                            (p._totalTime = p._time = g),
                                ...
                                ((o = !0),
                                    ...
                                    0 === p._duration && ((e <= 0 && -l <= e) || p._rawPrevTime < 0 || p._rawPrevTime === l) && p._rawPrevTime !== e && p._first && ((a = !0), p._rawPrevTime > l && (r = "onReverseComplete"))),
                                (p._rawPrevTime = p._duration || !t || e || p._rawPrevTime === e ? e : l),
                                (e = g + 1e-4);
                        else if (e < l)
                            if (
                                ((p._totalTime = p._time = 0),
                                    -l < e && (e = 0),
                                    (0 !== m || (0 === p._duration && p._rawPrevTime !== l && (0 < p._rawPrevTime || (e < 0 && 0 <= p._rawPrevTime)))) && ((r = "onReverseComplete"), (o = p._reversed)),
                                    e < 0)
                            )
                                (p._active = !1), p._timeline.autoRemoveChildren && p._reversed ? ((a = o = !0), (r = "onReverseComplete")) : 0 <= p._rawPrevTime && p._first && (a = !0), (p._rawPrevTime = e);
                            else {
                                if (((p._rawPrevTime = p._duration || !t || e || p._rawPrevTime === e ? e : l), 0 === e && o)) for (n = p._first; n && 0 === n._startTime;) n._duration || (o = !1), (n = n._next);
                                (e = 0), p._initted || (a = !0);
                            }
                        ...
                        if ((p._time !== m && p._first) || i || a || c) {
                            if (
                                (p._initted || (p._initted = !0),
                                    p._active || (!p._paused && p._time !== m && 0 < e && (p._active = !0)),
                                    0 === m && p.vars.onStart && ((0 === p._time && p._duration) || t || p._callback("onStart")),
                                    m <= (d = p._time))
                            )
                                for (n = p._first; n && ((s = n._next), d === p._time && (!p._paused || b));)
                            ...
                            p._onUpdate && (t || (h.length && f(), p._callback("onUpdate"))),
                                ...
                                (p._gc ||
                                    ...
                                    (o && (h.length && f(), p._timeline.autoRemoveChildren && p._enabled(!1, !1), (p._active = !1)), !t && p.vars[r] && p._callback(r)));
                        }
                    }),
                    ...
                    (v.rawTime = function (e) {
                        return e && (this._paused || (this._repeat && 0 < this.time() && 1 > this.totalProgress()))
                ...
                return (
                    ...
                    (d.render = function (e, t, i) {
                        ...
                        if ((g !== m._time && (e += m._time - g), v - o <= e && 0 <= e))
                            m._locked || ((m._totalTime = v), (m._cycle = m._repeat)),
                                ...
                                ((s = !0),
                                    ...
                                    0 === m._duration && ((e <= 0 && -o <= e) || x < 0 || x === o) && x !== e && m._first && ((d = !0), o < x && (c = "onReverseComplete"))),
                            ...
                            if (
                                (m._locked || (m._totalTime = m._cycle = 0),
                                    (m._time = 0),
                                    -o < e && (e = 0),
                                    (0 !== g || (0 === y && x !== o && (0 < x || (e < 0 && 0 <= x)) && !m._locked)) && ((c = "onReverseComplete"), (s = m._reversed)),
                                    e < 0)
                            )
                                (m._active = !1), m._timeline.autoRemoveChildren && m._reversed ? ((d = s = !0), (c = "onReverseComplete")) : 0 <= x && m._first && (d = !0), (m._rawPrevTime = e);
                            else {
                        ...
                        if (m._hasPause && !m._forcingPlayhead && !t) {
                            ...
                            else for (n = m._last; n && n._startTime >= e && !p;) n._duration || ("isPause" === n.data && 0 < n._rawPrevTime && (p = n)), (n = n._prev);
                            p &&
                                ((f = m._startTime + (m._reversed ? m._duration - p._startTime : p._startTime) / m._timeScale),
                                    p._startTime < y && ((m._time = m._rawPrevTime = e = p._startTime), (m._totalTime = e + m._cycle * (m._totalDuration + m._repeatDelay))));
                        }
                        if (m._cycle !== T && !m._locked) {
                            ...
                            if (
                                ((m._totalTime = T * y),
                                    ...
                                    (g = S ? 0 : y),
                                    m.render(g, t, 0 === y),
                                    t || m._gc || (m.vars.onRepeat && ((m._cycle = P), (m._locked = !1), m._callback("onRepeat"))),
                                    g !== m._time || (C && ((m._cycle = T), (m._locked = !0), (g = S ? y + 1e-4 : -1e-4), m.render(g, !0, !1)), (m._locked = !1), m._paused && !k))
                            )
                                return;
                        ...
                        if ((m._time !== g && m._first) || i || d || p) {
                            ...
                            m._onUpdate && (t || (r.length && a(), m._callback("onUpdate"))),
                                ...
                                (m._locked ||
                                    ...
                                    (s && (r.length && a(), m._timeline.autoRemoveChildren && m._enabled(!1, !1), (m._active = !1)), !t && m.vars[c] && m._callback(c)));
        ...
        (l = (a = _gsScope._gsDefine.plugin({
            ...
            init: function (e, t, i) {
                ...
                for (n in ((this._autoRotate = p ? (p instanceof Array ? p : [["x", "y", "rotation", !0 === p ? 0 : Number(p) || 0]]) : null), d)) this._props.push(n);
                for (s = this._props.length; -1 < --s;)
                    (n = this._props[s]),
                        this._overwriteProps.push(n),
                        (o = this._func[n] = "function" == typeof e[n]),
                        (c[n] = o ? e[n.indexOf("set") || "function" != typeof e["get" + n.substr(3)] ? n : "get" + n.substr(3)]() : parseFloat(e[n])),
                        a || (c[n] !== l[0][n] && (a = c));
                if (
                    ((this._beziers =
                        "cubic" !== t.type && "quadratic" !== t.type && "soft" !== t.type
                            ...
                            : (function (e, t, i) {
                                ...
                                for (l = y.length; -1 < --l;) {
                                    for (m[(p = y[l])] = a = [], h = 0, d = e.length, c = 0; c < d; c++)
                                        (n = null == i ? e[c][p] : "string" == typeof (f = e[c][p]) && "=" === f.charAt(1) ? i[p] + Number(f.charAt(0) + f.substr(2)) : Number(f)),
                                            v && 1 < c && c < d - 1 && (a[h++] = (n + a[h - 2]) / 2),
                                            (a[h++] = n);
                                    for (d = h - g + 1, c = h = 0; c < d; c += g)
                                        (n = a[c]), (o = a[c + 1]), (s = a[c + 2]), (r = 2 == g ? 0 : a[c + 3]), (a[h++] = f = 3 == g ? new u(n, o, s, r) : new u(n, (2 * o + n) / 3, (2 * o + s) / 3, s));
                                    a.length = h;
                                }
                                return m;
                            })(l, t.type, c)),
            ...
            set: function (e) {
                ...
                if (this._timeRes) {
                    ...
                    if (((i = o), (p -= this._l1), (o = this._si), p > this._s2 && o < u.length - 1)) {
                ...
                for (n = 1 - a, o = this._props.length; -1 < --o;)
                    (s = this._props[o]), (l = (a * a * (r = this._beziers[s][i]).da + 3 * n * (a * r.ca + n * r.ba)) * a + r.a), this._mod[s] && (l = this._mod[s](l, m)), f[s] ? m[s](l) : (m[s] = l);
                if (this._autoRotate) {
                    var v,
                        y,
                        b,
        ...
        (a.bezierThrough = m),
        (a.cubicToQuadratic = p),
        (a._autoCSS = !0),
        (a.quadraticToCubic = function (e, t, i) {
        ...
        (a._cssRegister = function () {
            ...
            if (e) {
                ...
                t._registerComplexSpecialProp("bezier", {
                    parser: function (e, t, s, r, l, c) {
                        t instanceof Array && (t = { values: t }), (c = new a());
                        var d,
                            u,
                            p,
                            h = t.values,
                            ...
                            g = {};
                        if (f < 0) return l;
                        for (d = 0; d <= f; d++) (p = i(e, h[d], r, l, c, f !== d)), (m[d] = p.end);
                        for (u in t) g[u] = t[u];
                        return (
                            (g.values = m),
                            ((l = new o(e, "bezier", 0, 0, p.pt, 2)).data = p),
                            (l.plugin = c),
                            (l.setRatio = n),
                            0 === g.autoRotate && (g.autoRotate = !0),
                            !g.autoRotate ||
                            g.autoRotate instanceof Array ||
                            ((d = !0 === g.autoRotate ? 0 : Number(g.autoRotate)), (g.autoRotate = null != p.end.left ? [["left", "top", "rotation", d, !1]] : null != p.end.x && [["x", "y", "rotation", d, !1]])),
                            g.autoRotate && (r._transform || r._enableTransforms(!1), (p.autoRotate = r._target._gsTransform), (p.proxy.rotation = p.autoRotate.rotation || 0), r._overwriteProps.push("rotation")),
                            c._onInitTween(p.proxy, g, r._tween),
                            l
                        );
                    },
                });
            ...
            function (e, t) {
                ...
                function g(e, t) {
                    var i,
                        ...
                        s = {};
                    if ((t = t || m(e)))
                        if ((i = t.length)) for (; -1 < --i;) (-1 !== (o = t[i]).indexOf("-transform") && qe !== o) || (s[o.replace(G, d)] = t.getPropertyValue(o));
                        else for (i in t) (-1 !== i.indexOf("Transform") && Be !== i) || (s[i] = t[i]);
                    else if ((t = e.currentStyle || e.style)) for (i in t) "string" == typeof i && void 0 === s[i] && (s[i.replace(G, d)] = t[i]);
                    return (
                        ae || (s.opacity = p(e)),
                        (n = Ve(e, t, !1)),
                        ...
                        (s.x = n.x),
                        (s.y = n.y),
                        He && ((s.z = n.z), (s.rotationX = n.rotationX), (s.rotationY = n.rotationY), (s.scaleZ = n.scaleZ)),
                ...
                function v(e, t, i, n, o) {
                    ...
                    for (r in i)
                        "cssText" !== r &&
                            ...
                            ((l[r] = "auto" !== s || ("left" !== r && "top" !== r) ? (("" !== s && "auto" !== s && "none" !== s) || "string" != typeof t[r] || "" === t[r].replace(R, "") ? s : 0) : he(e, r)),
                ...
                var T,
                    ...
                    ae =
                        ((z = re.indexOf("Android")),
                            (I = u("a")),
                            (P = (C = -1 !== re.indexOf("Safari") && -1 === re.indexOf("Chrome") && (-1 === z || 3 < parseFloat(re.substr(z + 8, 2)))) && 6 > parseFloat(re.substr(re.indexOf("Version/") + 8, 2))),
                            (j = -1 !== re.indexOf("Firefox")),
                            (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(re) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(re)) && (E = parseFloat(RegExp.$1)),
                            !!I && ((I.style.cssText = "top:1px;opacity:.55;"), /^0.55/.test(I.style.opacity))),
                    le = "",
                    ce = "",
                    de = "undefined" != typeof window ? window : ie.defaultView || { getComputedStyle: function () { } },
                    ue = (r.getStyle = function (e, t, i, n, o) {
                        var s;
                        return ae || "opacity" !== t
                            ? (!n && e.style[t] ? (s = e.style[t]) : (i = i || m(e)) ? (s = i[t] || i.getPropertyValue(t) || i.getPropertyValue(t.replace(W, "-$1").toLowerCase())) : e.currentStyle && (s = e.currentStyle[t]),
                    ...
                    pe = (se.convertToPixels = function (e, i, n, o, s) {
                        ...
                        if ((h && (n = -n), f && (n *= 100), "lineHeight" !== i || o))
                            if ("%" === o && -1 !== i.indexOf("border")) a = (n / 100) * (d ? e.clientWidth : e.clientHeight);
                                ...
                                if (((p.cssText = "border:0 solid red;position:" + ue(e, "position") + ";line-height:0;"), "%" !== o && u.appendChild && "v" !== o.charAt(0) && "rem" !== o))
                                    p[d ? "borderLeftWidth" : "borderTopWidth"] = n + o;
                                else {
                                    if ((-1 !== ue((u = e.parentNode || ie.body), "display").indexOf("flex") && (p.position = "absolute"), (l = u._gsCache), (c = t.ticker.frame), l && d && l.time === c)) return (l.width * n) / 100;
                                    p[d ? "width" : "height"] = n + o;
                                }
                                u.appendChild(ne),
                                    (a = parseFloat(ne[d ? "offsetWidth" : "offsetHeight"])),
                                    u.removeChild(ne),
                                    d && "%" === o && !1 !== r.cacheWidths && (((l = u._gsCache = u._gsCache || {}).time = c), (l.width = (a / n) * 100)),
                    ...
                    ye = (r.parseColor = function (e, t) {
                        ...
                        return (
                            ...
                            !p &&
                            ((n = i[0] / 255),
                                (l = ((c = Math.max(n, (o = i[1] / 255), (s = i[2] / 255))) + (d = Math.min(n, o, s))) / 2),
                                c === d ? (r = a = 0) : ((u = c - d), (a = 0.5 < l ? u / (2 - c - d) : u / (c + d)), (r = c === n ? (o - s) / u + (o < s ? 6 : 0) : c === o ? (s - n) / u + 2 : (n - o) / u + 4), (r *= 60)),
                                (i[0] = (r + 0.5) | 0),
                                (i[1] = (100 * a + 0.5) | 0),
                                (i[2] = (100 * l + 0.5) | 0)),
                            i
                    ...
                    return d
                        ? (o = t
                            ? function (e) {
                                ...
                                if (((t = (e.match(be) || [s])[0]), (h = (p = e.split(t).join("").match(M) || []).length), d > h--)) for (; ++h < d;) p[h] = i ? p[((h - 1) / 2) | 0] : r[h];
                            ...
                            : function (e) {
                                ...
                                if (((p = (t = e.match("," == c ? M : $) || []).length), d > p--)) for (; ++p < d;) t[p] = i ? t[((p - 1) / 2) | 0] : r[p];
                        ...
                        for (
                            ...
                            ((j =
                                -1 !== (n + i).indexOf("rgb") || -1 !== (n + i).indexOf("hsl")
                                    ? ((C = C.join(" ").replace(K, ", ").split(" ")), j.join(" ").replace(K, ", ").split(" "))
                                    : ((C = C.join(" ").split(",").join(", ").split(" ")), j.join(" ").split(",").join(", ").split(" "))),
                                (P = C.length)),
                            ...
                            if (((f = C[u]), (m = j[u] + ""), (y = parseFloat(f)) || 0 === y)) a.appendXtra("", y, b(m, y), m.replace(D, ""), E && -1 !== m.indexOf("px") && Math.round, !0);
                                ...
                                (k = ")" + ((k = m.indexOf(")") + 1) ? m.substr(k) : "")),
                                    ...
                                    (_ = 6 < f.length + m.length) && !ae && 0 === m[3]
                                        ? ((a["xs" + a.l] += a.l ? " transparent" : "transparent"), (a.e = a.e.split(j[u]).join("transparent")))
                                        : (ae || (_ = !1),
                                            S
                                                ? a
                                                    .appendXtra(w.substr(0, w.indexOf("hsl")) + (_ ? "hsla(" : "hsl("), f[0], b(m[0], f[0]), ",", !1, !0)
                                                    .appendXtra("", f[1], b(m[1], f[1]), "%,", !1)
                                                    .appendXtra("", f[2], b(m[2], f[2]), _ ? "%," : "%" + k, !1)
                                                : a
                                                    .appendXtra(w.substr(0, w.indexOf("rgb")) + (_ ? "rgba(" : "rgb("), f[0], m[0] - f[0], ",", Math.round, !0)
                                                    .appendXtra("", f[1], m[1] - f[1], ",", Math.round)
                                                    .appendXtra("", f[2], m[2] - f[2], _ ? "," : k, Math.round),
                                            _ && ((f = f.length < 4 ? 1 : f[3]), a.appendXtra("", f, (m.length < 4 ? 1 : m[3]) - f, k, !1))),
                                    (be.lastIndex = 0);
                            else if ((g = f.match(L))) {
                                if (!(v = m.match(D)) || v.length !== g.length) return a;
                                for (p = h = 0; p < g.length; p++)
                                    (x = g[p]), (w = f.indexOf(x, h)), a.appendXtra(f.substr(h, w - h), Number(x), b(v[p], x), "", E && "px" === f.substr(w + x.length, 2) && Math.round, 0 === p), (h = w + x.length);
                                a["xs" + a.l] += f.substr(h);
                ...
                function Ae(e, t, i, n, o, s) {
                    ...
                    w && ((b = w.xOrigin), (_ = w.yOrigin)),
                        ...
                        ((p = x[0]),
                            ...
                            (g = x[4]),
                            (v = x[5]),
                            (y = p * m - h * f) && ((l = d * (m / y) + u * (-f / y) + (f * v - m * g) / y), (c = d * (-h / y) + u * (p / y) - (p * v - h * g) / y), (d = i.xOrigin = a[0] = l), (u = i.yOrigin = a[1] = c))),
                        w &&
                        (s && ((i.xOffset = w.xOffset), (i.yOffset = w.yOffset), (w = i)),
                            o || (!1 !== o && !1 !== r.defaultSmoothOrigin) ? ((l = d - b), (c = u - _), (w.xOffset += l * x[0] + c * x[2] - l), (w.yOffset += l * x[1] + c * x[3] - c)) : (w.xOffset = w.yOffset = 0)),
                ...
                function ze(e) {
                    ...
                    if (p) {
                        ...
                        if (
                            (null != n.ox && ((b += (h = (n.oxp ? m * n.ox * 0.01 : n.ox) - m / 2) - (h * a + (f = (n.oyp ? g * n.oy * 0.01 : n.oy) - g / 2) * l)), (_ += f - (h * c + f * d))),
                                (y += v ? ", Dx=" + ((h = m / 2) - (h * a + (f = g / 2) * l) + b) + ", Dy=" + (f - (h * c + f * d) + _) + ")" : ", sizingMethod='auto expand')"),
                            ...
                            for (
                                ...
                                n.ieOffsetY = Math.round((g - ((d < 0 ? -d : d) * g + (c < 0 ? -c : c) * m)) / 2 + _),
                                Ce = 0;
                                Ce < 4;
                                Ce++
                            )
                                (k =
                                    (i = -1 !== (w = p[(x = me[Ce])]).indexOf("px") ? parseFloat(w) : pe(this.t, x, parseFloat(w), w.replace(B, "")) || 0) !== n[x]
                                        ? Ce < 2
                                            ? -n.ieOffsetX
                                            : -n.ieOffsetY
                                        : Ce < 2
                ...
                ((c = je.prototype).parseComplex = function (e, t, i, n, o, s) {
                    ...
                    if ((this.multi && (K.test(i) || K.test(t) ? ((a = t.replace(K, "|").split("|")), (l = i.replace(K, "|").split("|"))) : p && ((a = [t]), (l = [i]))), l)) {
                        for (c = l.length > a.length ? l.length : a.length, r = 0; r < c; r++)
                            (t = a[r] = a[r] || this.dflt), (i = l[r] = l[r] || this.dflt), p && (d = t.indexOf(p)) !== (u = i.indexOf(p)) && (-1 === u ? (a[r] = a[r].split(p).join("")) : -1 === d && (a[r] += " " + p));
                        (t = a.join(", ")), (i = l.join(", "));
                    }
                ...
                var Ie,
                    ...
                    Ue =
                        (($e = E || (/Android/i.test(re) && !_gsScope.chrome)),
                            ...
                            !$e &&
                            ((Le = Oe("svg", Ge)),
                                (Me = (De = Oe("rect", Le, { width: 100, height: 50, x: 100 })).getBoundingClientRect().width),
                                (De.style[Fe] = "50% 50%"),
                    ...
                    Ye = function (e) {
                        ...
                        if ((Ge.appendChild(i), i.appendChild(this), (this.style.display = "block"), e))
                            try {
                    ...
                    Ke = function (e, t) {
                        ...
                        if (
                            (Be
                                ? (n = ue(e, qe, null, !0))
                                : e.currentStyle && (n = (n = e.currentStyle.filter.match(X)) && 4 === n.length ? [n[0].substr(4), Number(n[2].substr(4)), Number(n[1].substr(4)), n[3].substr(4), c.x || 0, c.y || 0].join(",") : ""),
                                ...
                                ((s = d.display),
                                    (d.display = "block"),
                                    ((l = e.parentNode) && e.offsetParent) || ((r = 1), (a = e.nextSibling), Ge.appendChild(e)),
                                    (i = !(n = ue(e, qe, null, !0)) || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n),
                                    s ? (d.display = s) : tt(d, "display"),
                                    r && (a ? l.insertBefore(e, a) : l ? l.appendChild(e) : Ge.removeChild(e))),
                                (c.svg || (e.getCTM && Xe(e))) &&
                                (i && -1 !== (d[Be] + "").indexOf("matrix") && ((n = d[Be]), (i = 0)),
                                    (o = e.getAttribute("transform")),
                                    i && o && ((n = "matrix(" + (o = e.transform.baseVal.consolidate().matrix).a + "," + o.b + "," + o.c + "," + o.d + "," + o.e + "," + o.f + ")"), (i = 0))),
                                i)
                        )
                            return Qe;
                        for (Ce = (o = (n || "").match(L) || []).length; -1 < --Ce;) (s = Number(o[Ce])), (o[Ce] = (r = s - (s |= 0)) ? ((1e5 * r + (r < 0 ? -0.5 : 0.5)) | 0) / 1e5 + s : s);
                        ...
                        if (((p.svg = !(!e.getCTM || !Xe(e))), p.svg && (Ae(e, ue(e, Fe, i, !1, "50% 50%") + "", p, e.getAttribute("data-svg-origin")), (Ie = r.useSVGTransformAttr || Ue)), (s = Ke(e)) !== Qe)) {
                            if (16 === s.length) {
                                var g,
                                    ...
                                    D = s[11],
                                    M = Math.atan2(j, A);
                                p.zOrigin && ((z = E * (L = -p.zOrigin) - s[12]), (I = O * L - s[13]), (L = A * L + p.zOrigin - s[14])),
                                    (p.rotationX = M * Z),
                                    M &&
                                    ...
                                    (M = Math.atan2(-k, A)),
                                    (p.rotationY = M * Z),
                                    M && ((v = x * (b = Math.cos(-M)) - O * (_ = Math.sin(-M))), (y = k * b - A * _), (O = x * _ + O * b), (A = k * _ + A * b), (D = T * _ + D * b), (w = g = w * b - E * _), (x = v), (k = y)),
                                    (M = Math.atan2(x, w)),
                                    (p.rotation = M * Z),
                                    M && ((g = w * (b = Math.cos(M)) + x * (_ = Math.sin(M))), (v = S * b + C * _), (y = E * b + O * _), (x = x * b - w * _), (C = C * b - S * _), (O = O * b - E * _), (w = g), (S = v), (E = y)),
                                    p.rotationX && 359.9 < Math.abs(p.rotationX) + Math.abs(p.rotation) && ((p.rotationX = p.rotation = 0), (p.rotationY = 180 - p.rotationY)),
                                    (M = Math.atan2(S, C)),
                                    (p.scaleX = ((1e5 * Math.sqrt(w * w + x * x + k * k) + 0.5) | 0) / 1e5),
                                    (p.scaleY = ((1e5 * Math.sqrt(C * C + j * j) + 0.5) | 0) / 1e5),
                                    (p.scaleZ = ((1e5 * Math.sqrt(E * E + O * O + A * A) + 0.5) | 0) / 1e5),
                                    (w /= p.scaleX),
                                    (S /= p.scaleY),
                                    (x /= p.scaleX),
                                    (C /= p.scaleY),
                                    2e-5 < Math.abs(M) ? ((p.skewX = M * Z), (S = 0), "simple" !== p.skewType && (p.scaleY *= 1 / Math.cos(M))) : (p.skewX = 0),
                                    (p.perspective = D ? 1 / (D < 0 ? -D : D) : 0),
                                    (p.x = z),
                                    (p.y = I),
                                    (p.z = L),
                                    p.svg && ((p.x -= p.xOrigin - (p.xOrigin * w - p.yOrigin * S)), (p.y -= p.yOrigin - (p.yOrigin * x - p.xOrigin * C)));
                                ...
                                (p.x = s[4] || 0),
                                    ...
                                    (p.rotation = d),
                                    (p.skewX = u),
                                    He && ((p.rotationX = p.rotationY = p.z = 0), (p.perspective = m), (p.scaleZ = 1)),
                                    p.svg && ((p.x -= p.xOrigin - (p.xOrigin * R + p.yOrigin * q)), (p.y -= p.yOrigin - (p.xOrigin * B + p.yOrigin * F)));
                            }
                    ...
                    Je = (se.set3DTransformRatio = se.setTransformRatio = function (e) {
                        var t,
                            ...
                            B = T.skewY,
                            q = T.skewX;
                        if ((B && ((q += B), (C += B)), !((((1 !== e && 0 !== e) || "auto" !== R || (this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime)) && R) || D || $ || E || P || 1 !== z) || (Ie && M) || !He))
                            C || q || M
                                ? ((C *= J),
                                    (x = q * J),
                                    (k = 1e5),
                                    ...
                                    (n = -Math.sin(C - x) * A),
                                    (r = Math.cos(C - x) * A),
                                    x && "simple" === T.skewType && ((n *= t = Math.sqrt(1 + (t = Math.tan(x - B * J)) * t)), (r *= t), B && ((i *= t = Math.sqrt(1 + (t = Math.tan(B * J)) * t)), (s *= t))),
                                    M &&
                                    ((I += T.xOrigin - (T.xOrigin * i + T.yOrigin * n) + T.xOffset),
                                        (L += T.yOrigin - (T.xOrigin * s + T.yOrigin * r) + T.yOffset),
                                        Ie && (T.xPercent || T.yPercent) && ((m = this.t.getBBox()), (I += 0.01 * T.xPercent * m.width), (L += 0.01 * T.yPercent * m.height)),
                                        I < (m = 1e-6) && -m < I && (I = 0),
                                        L < m && -m < L && (L = 0)),
                                    (b = ((i * k) | 0) / k + "," + ((s * k) | 0) / k + "," + ((n * k) | 0) / k + "," + ((r * k) | 0) / k + "," + I + "," + L + ")"),
                                    M && Ie ? this.t.setAttribute("transform", "matrix(" + b) : (S[Be] = (T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) matrix(" : "matrix(") + b))
                                : (S[Be] = (T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) matrix(" : "matrix(") + O + ",0,0," + A + "," + I + "," + L + ")");
                        else {
                            if ((j && (O < (m = 1e-4) && -m < O && (O = z = 2e-5), A < m && -m < A && (A = z = 2e-5), !$ || T.z || T.rotationX || T.rotationY || ($ = 0)), C || q))
                                (C *= J),
                                    (g = i = Math.cos(C)),
                                    (v = s = Math.sin(C)),
                                    q &&
                                    ((C -= q * J),
                                        (g = Math.cos(C)),
                                        (v = Math.sin(C)),
                                        "simple" === T.skewType && ((g *= t = Math.sqrt(1 + (t = Math.tan((q - B) * J)) * t)), (v *= t), T.skewY && ((i *= t = Math.sqrt(1 + (t = Math.tan(B * J)) * t)), (s *= t)))),
                                    (n = -v),
                                    (r = g);
                            else {
                                if (!(E || P || 1 !== z || $ || M))
                            ...
                            (d = 1),
                                ...
                                (_ = ","),
                                (w = "0"),
                                (C = E * J) && ((g = Math.cos(C)), (u = h * (l = -(v = Math.sin(C)))), (o = i * v), (a = s * v), (h *= d = g), (i *= g), (s *= g)),
                                (C = P * J) && ((t = n * (g = Math.cos(C)) + o * (v = Math.sin(C))), (y = r * g + a * v), (c = d * v), (p = h * v), (o = -n * v + o * g), (a = -r * v + a * g), (d *= g), (h *= g), (n = t), (r = y)),
                                1 !== z && ((o *= z), (a *= z), (d *= z), (h *= z)),
                                1 !== A && ((n *= A), (r *= A), (c *= A), (p *= A)),
                                1 !== O && ((i *= O), (s *= O), (l *= O), (u *= O)),
                                (f || M) &&
                                (f && ((I += -o * f), (L += -a * f), (D += -d * f + f)),
                                    M && ((I += T.xOrigin - (T.xOrigin * i + T.yOrigin * n) + T.xOffset), (L += T.yOrigin - (T.xOrigin * s + T.yOrigin * r) + T.yOffset)),
                                    I < m && -m < I && (I = w),
                                    L < m && -m < L && (L = w),
                                    D < m && -m < D && (D = 0)),
                                ...
                                P || E || 1 !== z
                                    ? ((b += _ + (c < m && -m < c ? w : c) + _ + (p < m && -m < p ? w : p) + _ + (o < m && -m < o ? w : o)),
                                        (b += _ + (a < m && -m < a ? w : a) + _ + (d < m && -m < d ? w : d) + _ + (h < m && -m < h ? w : h) + _))
                                    : (b += ",0,0,0,0,1,0,"),
                                (b += I + _ + L + _ + D + _ + ($ ? 1 + -D / $ : 1) + ")"),
                                (S[Be] = b);
                        }
                ...
                function Ze(e) {
                    var t,
                        ...
                        o = (this.s + this.c * e) | 0;
                    100 == o && (t = -1 === n.indexOf("atrix(") && -1 === n.indexOf("radient(") && -1 === n.indexOf("oader(") ? (i.removeAttribute("filter"), !ue(this.data, "filter")) : ((i.filter = n.replace(H, "")), !0)),
                        t || (this.xn1 && (i.filter = n = n || "alpha(opacity=" + o + ")"), -1 === n.indexOf("pacity") ? (0 == o && this.xn1) || (i.filter = n + " alpha(opacity=" + o + ")") : (i.filter = n.replace(q, "opacity=" + o)));
                }
                function et(e) {
                ...
                ((c = Ne.prototype).x = c.y = c.z = c.skewX = c.skewY = c.rotation = c.rotationX = c.rotationY = c.zOrigin = c.xPercent = c.yPercent = c.xOffset = c.yOffset = 0),
                    ...
                    Pe(
                        "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
                        {
                            parser: function (e, t, i, n, s, a, l) {
                                ...
                                if (((j.skewType = T.skewType || j.skewType || r.defaultSkewType), (n._transform = j), "rotationZ" in T && (T.rotation = T.rotationZ), P && "string" == typeof P && Be))
                                    ((u = ne.style)[Be] = P),
                                        (u.display = "block"),
                                        (u.position = "absolute"),
                                        -1 !== P.indexOf("%") && ((u.width = ue(e, "width")), (u.height = ue(e, "height"))),
                                        ie.body.appendChild(ne),
                                        (d = Ve(ne, null, !1)),
                                        "simple" === j.skewType && (d.scaleY *= Math.cos(d.skewX * J)),
                                        j.svg &&
                                        ((m = j.xOrigin),
                                            (g = j.yOrigin),
                                            (d.x -= j.xOffset),
                                            ...
                                            ((P = {}), Ae(e, ge(T.transformOrigin), P, T.svgOrigin, T.smoothOrigin, !0), (m = P.xOrigin), (g = P.yOrigin), (d.x -= P.xOffset - j.xOffset), (d.y -= P.yOffset - j.yOffset)),
                                            (m || g) && ((v = Ke(ne, !0)), (d.x -= m - (m * v[0] + g * v[2])), (d.y -= g - (m * v[1] + g * v[3])))),
                                        ie.body.removeChild(ne),
                                        d.perspective || (d.perspective = j.perspective),
                                        null != T.xPercent && (d.xPercent = _(T.xPercent, j.xPercent)),
                                        null != T.yPercent && (d.yPercent = _(T.yPercent, j.yPercent));
                                    ...
                                    "string" == typeof T.x && -1 !== T.x.indexOf("%") && ((d.x = 0), (d.xPercent = _(T.x, j.xPercent))),
                                        "string" == typeof T.y && -1 !== T.y.indexOf("%") && ((d.y = 0), (d.yPercent = _(T.y, j.yPercent))),
                                        (d.rotation = w("rotation" in T ? T.rotation : "shortRotation" in T ? T.shortRotation + "_short" : j.rotation, j.rotation, "rotation", S)),
                                        He &&
                                        ((d.rotationX = w("rotationX" in T ? T.rotationX : "shortRotationX" in T ? T.shortRotationX + "_short" : j.rotationX || 0, j.rotationX, "rotationX", S)),
                                            (d.rotationY = w("rotationY" in T ? T.rotationY : "shortRotationY" in T ? T.shortRotationY + "_short" : j.rotationY || 0, j.rotationY, "rotationY", S))),
                                        (d.skewX = w(T.skewX, j.skewX)),
                                        (d.skewY = w(T.skewY, j.skewY));
                                }
                                for (
                                    He && null != T.force3D && ((j.force3D = T.force3D), (h = !0)),
                                    (p = j.force3D || j.z || j.rotationX || j.rotationY || d.z || d.rotationX || d.rotationY || d.perspective) || null == T.scale || (d.scaleZ = 1);
                                    -1 < --k;

                                )
                                    (1e-6 < (P = d[(y = Re[k])] - j[y]) || P < -1e-6 || null != T[y] || null != ee[y]) &&
                                        ((h = !0), (s = new Te(j, y, j[y], P, s)), y in S && (s.e = S[y]), (s.xs0 = 0), (s.plugin = a), n._overwriteProps.push(s.n));
                                return (
                                    (P = "function" == typeof T.transformOrigin ? T.transformOrigin(A, O) : T.transformOrigin),
                                    j.svg &&
                                    (P || T.svgOrigin) &&
                                    ((m = j.xOffset),
                                        (g = j.yOffset),
                                        Ae(e, ge(P), d, T.svgOrigin, T.smoothOrigin),
                                        (s = xe(j, "xOrigin", (b ? j : d).xOrigin, d.xOrigin, s, C)),
                                        (s = xe(j, "yOrigin", (b ? j : d).yOrigin, d.yOrigin, s, C)),
                                        (m === j.xOffset && g === j.yOffset) || ((s = xe(j, "xOffset", b ? m : j.xOffset, j.xOffset, s, C)), (s = xe(j, "yOffset", b ? g : j.yOffset, j.yOffset, s, C))),
                                        (P = "0px 0px")),
                                    (P || (He && p && j.zOrigin)) &&
                                    (Be
                                        ? ((h = !0),
                                            (y = Fe),
                                            P || (P = (P = (ue(e, y, o, !1, "50% 50%") + "").split(" "))[0] + " " + P[1] + " " + j.zOrigin + "px"),
                                            (P += ""),
                                            ...
                                            He
                                                ? ((u = j.zOrigin),
                                                    (P = P.split(" ")),
                                                    (j.zOrigin = (2 < P.length ? parseFloat(P[2]) : u) || 0),
                                                    (s.xs0 = s.e = P[0] + " " + (P[1] || "50%") + " 0px"),
                                                    ((s = new Te(j, "zOrigin", 0, 0, s, -1, s.n)).b = u),
                                                    (s.xs0 = s.e = j.zOrigin))
                                                : (s.xs0 = s.e = P))
                                        : ge(P + "", j)),
                                    h && (n._transformType = (j.svg && Ie) || (!p && 3 !== this._transformType) ? 2 : 3),
                                    c && (l.scale = c),
                                    s
                                );
                            },
                    ...
                    Pe("boxShadow", { defaultValue: "0px 0px 0px 0px #999", prefix: !0, color: !0, multi: !0, keyword: "inset" }),
                    Pe("clipPath", { defaultValue: "inset(0%)", prefix: !0, multi: !0, formatter: _e("inset(0% 0% 0% 0%)", !1, !0) }),
                    Pe("borderRadius", {
                        defaultValue: "0px",
                        parser: function (e, t, i, s, r, a) {
                            ...
                            var l,
                                ...
                                C = e.style;
                            for (v = parseFloat(e.offsetWidth), y = parseFloat(e.offsetHeight), l = t.split(" "), c = 0; c < S.length; c++)
                                this.p.indexOf("border") && (S[c] = f(S[c])),
                                    -1 !== (p = u = ue(e, S[c], o, !1, "0px")).indexOf(" ") && ((p = (u = p.split(" "))[0]), (u = u[1])),
                                    (h = d = l[c]),
                                    (m = parseFloat(p)),
                                    (_ = p.substr((m + "").length)),
                                    "" ===
                                    (b = (w = "=" === h.charAt(1))
                                        ? ((g = parseInt(h.charAt(0) + "1", 10)), (g *= parseFloat((h = h.substr(2)))), h.substr((g + "").length - (g < 0 ? 1 : 0)) || "")
                                        : ((g = parseFloat(h)), h.substr((g + "").length))) && (b = n[i] || _),
                                    b !== _ &&
                                    ((x = pe(e, "borderLeft", m, _)),
                                        (k = pe(e, "borderTop", m, _)),
                                        (u = "%" === b ? ((p = (x / v) * 100 + "%"), (k / y) * 100 + "%") : "em" === b ? ((p = x / (T = pe(e, "borderLeft", 1, "em")) + "em"), k / T + "em") : ((p = x + "px"), k + "px")),
                                        w && ((h = parseFloat(p) + g + b), (d = parseFloat(u) + g + b))),
                    ...
                    Pe("backgroundPosition", {
                        ...
                        parser: function (e, t, i, n, s, r) {
                            ...
                            if ((-1 !== g.indexOf("%")) != (-1 !== v.indexOf("%")) && v.split(",").length < 2 && (p = ue(e, "backgroundImage").replace(U, "")) && "none" !== p) {
                                for (a = g.split(" "), l = v.split(" "), oe.setAttribute("src", p), c = 2; -1 < --c;)
                                    (d = -1 !== (g = a[c]).indexOf("%")) != (-1 !== l[c].indexOf("%")) &&
                                        ((u = 0 === c ? e.offsetWidth - oe.width : e.offsetHeight - oe.height), (a[c] = d ? (parseFloat(g) / 100) * u + "px" : (parseFloat(g) / u) * 100 + "%"));
                                g = a.join(" ");
                            }
                    ...
                    Pe("margin", { parser: we("marginTop,marginRight,marginBottom,marginLeft") }),
                    Pe("padding", { parser: we("paddingTop,paddingRight,paddingBottom,paddingLeft") }),
                    Pe("clip", {
                        ...
                        parser: function (e, t, i, n, s, r) {
                            ...
                            return (
                                (t =
                                    E < 9
                                        ? ((l = e.currentStyle), (c = E < 8 ? " " : ","), (a = "rect(" + l.clipTop + c + l.clipRight + c + l.clipBottom + c + l.clipLeft + ")"), this.format(t).split(",").join(c))
                                        : ((a = this.format(ue(e, this.p, o, !1, this.dflt))), this.format(t))),
                                this.parseComplex(e.style, a, t, s, r)
                            );
                        },
                    }),
                    Pe("textShadow", { defaultValue: "0px 0px 0px #999", color: !0, multi: !0 }),
                    ...
                    Pe("border", {
                        ...
                        parser: function (e, t, i, n, s, r) {
                            var a = ue(e, "borderTopWidth", o, !1, "0px"),
                                ...
                                c = l[0].replace(B, "");
                            return (
                                "px" !== c && (a = parseFloat(a) / pe(e, "borderTopWidth", 1, c) + c),
                    ...
                    Pe("borderWidth", { parser: we("borderTopWidth,borderRightWidth,borderBottomWidth,borderLeftWidth") }),
                    ...
                    Pe("opacity,alpha,autoAlpha", {
                        ...
                        parser: function (e, t, i, n, s, r) {
                            ...
                            return (
                                ...
                                c && 1 === a && "hidden" === ue(e, "visibility", o) && 0 !== t && (a = 0),
                                ae
                                    ? (s = new Te(l, "opacity", a, t - a, s))
                                    : (((s = new Te(l, "opacity", 100 * a, 100 * (t - a), s)).xn1 = c ? 1 : 0),
                                        (l.zoom = 1),
                                        (s.type = 2),
                                        ...
                                        (s.plugin = r),
                                        (s.setRatio = Ze)),
                                c && (((s = new Te(l, "visibility", 0, 0, s, -1, null, !1, 0, 0 !== a ? "inherit" : "hidden", 0 === t ? "hidden" : "inherit")).xs0 = "inherit"), n._overwriteProps.push(s.n), n._overwriteProps.push(i)),
                                s
                            );
                        },
                    });
                ...
                function it(e) {
                    if ((1 === e || 0 === e) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                        ...
                        else for (n = (t = this.e.split(" ").join("").split(",")).length; -1 < --n;) l[(i = t[n])] && (l[i].parse === a ? (o = !0) : (i = "transformOrigin" === i ? Fe : l[i].p)), tt(r, i);
                ...
                for (
                    Pe("className", {
                        parser: function (e, t, n, s, r, a, l) {
                            ...
                            return (
                                ((e._gsClassPT = r).e = "=" !== t.charAt(1) ? t : f.replace(RegExp("(?:\\s|^)" + t.substr(2) + "(?![\\w-])"), "") + ("+" === t.charAt(0) ? " " + t.substr(2) : "")),
                    ...
                    Ce = (c = "bezier,throwProps,physicsProps,physics2D".split(",")).length;
                    Ce--;
                ...
                ((c = r.prototype)._firstPT = c._lastParsedTransform = c._transform = null),
                    (c._onInitTween = function (e, t, a, c) {
                        ...
                        var d,
                            ...
                            x = e.style;
                        if (
                            (S && "" === x.zIndex && (("auto" !== (d = ue(e, "zIndex", o)) && "" !== d) || this._addLazySet(x, "zIndex", 0)),
                                "string" == typeof t && ((h = x.cssText), (d = g(e, o)), (x.cssText = h + ";" + t), (d = v(e, d, g(e)).difs), !ae && F.test(t) && (d.opacity = parseFloat(RegExp.$1)), (t = d), (x.cssText = h)),
                            ...
                            for (
                                ...
                                Be
                                    ...
                                    ((S = !0),
                                        ...
                                        P && this._addLazySet(x, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (w ? "visible" : "hidden")))
                                    : (x.zoom = 1),
                                p = u;
                                p && p._next;
                    ...
                    (c.parse = function (e, t, i, s) {
                        ...
                        for (r in t) {
                            if (((p = t[r]), (a = l[r]), "function" != typeof p || (a && a.allowFunc) || (p = p(A, O)), a)) i = a.parse(e, p, r, this, i, s, t);
                                ...
                                (u = ue(e, r, o) + ""),
                                    (v = "string" == typeof p),
                                    "color" === r || "fill" === r || "stroke" === r || -1 !== r.indexOf("Color") || (v && N.test(p))
                                        ? (v || (p = (3 < (p = ye(p)).length ? "rgba(" : "rgb(") + p.join(",") + ")"), (i = Se(_, r, u, p, !0, "transparent", i, 0, s)))
                                        : v && V.test(p)
                                            ? (i = Se(_, r, u, p, !0, null, i, 0, s))
                                            : ((f = (c = parseFloat(u)) || 0 === c ? u.substr((c + "").length) : ""),
                                                ("" !== u && "auto" !== u) || (f = "width" === r || "height" === r ? ((c = y(e, r, o)), "px") : "left" === r || "top" === r ? ((c = he(e, r, o)), "px") : ((c = "opacity" !== r ? 0 : 1), "")),
                                                "" === (g = (b = v && "=" === p.charAt(1)) ? ((d = parseInt(p.charAt(0) + "1", 10)), (d *= parseFloat((p = p.substr(2)))), p.replace(B, "")) : ((d = parseFloat(p)), v ? p.replace(B, "") : "")) &&
                                                (g = r in n ? n[r] : f),
                                                ...
                                                ((c = pe(e, r, c, f)),
                                                    "%" === g
                                                        ? ((c /= pe(e, r, 100, "%") / 100), !0 !== t.strictUnits && (u = c + "%"))
                                                ...
                                                b && (d += c),
                                                (!c && 0 !== c) || (!d && 0 !== d)
                                                    ? void 0 !== _[r] && (p || (p + "" != "NaN" && null != p))
                                                        ? ((i = new Te(_, r, d || c || 0, 0, i, -1, r, !1, 0, u, p)).xs0 = "none" !== p || ("display" !== r && -1 === r.indexOf("Style")) ? p : u)
                                                        : h("invalid " + r + " tween value: " + t[r])
                                                    : ((i = new Te(_, r, c, d - c, i, 0, r, !1 !== T && ("px" === g || "zIndex" === r), 0, u, p)).xs0 = g));
                            }
                ...
                return (
                    (r.cascadeTo = function (e, i, n) {
                        ...
                        for (ot((e = l._targets || l.target), d, p), l.render(i, !0, !0), ot(e, u), l.render(0, !0, !0), l._enabled(!0), o = p.length; -1 < --o;)
        ...
        ((e = _gsScope._gsDefine.plugin({
            ...
            if ("object" != typeof s || s.push) for ("string" == typeof s && (s = s.split(",")), i = s.length; -1 < --i;) r[s[i]] = Math.round;
            else for (n in s) r[n] = c(s[n]);
            for (n in r)
                for (e = o._firstPT; e;)
                    (t = e._next),
                        e.pg
                            ...
                            (2 === e.f && e.t
                                ? d(e.t._firstPT, r[n])
                                : (this._add(e.t, n, e.s, e.c, r[n]), t && (t._prev = e._prev), e._prev ? (e._prev._next = t) : o._firstPT === e && (o._firstPT = t), (e._next = e._prev = null), (o._propLookup[n] = a))),
                        (e = t);
            return !1;
        }),
        (e._add = function (e, t, i, n, o) {
                ...
                for (o in t)
                    "useRadians" !== o &&
                        ("function" == typeof (a = t[o]) && (a = a(n, e)),
                            ...
                            c.length &&
                            (-1 !== (s = c.join("_")).indexOf("short") && (l %= d) != l % (d / 2) && (l = l < 0 ? l + d : l - d),
                                -1 !== s.indexOf("_cw") && l < 0 ? (l = ((l + 9999999999 * d) % d) - ((l / d) | 0) * d) : -1 !== s.indexOf("ccw") && 0 < l && (l = ((l - 9999999999 * d) % d) - ((l / d) | 0) * d)),
                        ...
                        function (t) {
                            for (
                                ...
                                (i = f ? Math.random() : (1 / p) * h),
                                    (o = g ? g.getRatio(i) : i),
                                    (s = "none" === c ? v : "out" === c ? (r = 1 - i) * r * v : "in" === c ? i * i * v : (r = i < 0.5 ? 2 * i : 2 * (1 - i)) * r * 0.5 * v),
                                    f ? (o += Math.random() * s - 0.5 * s) : h % 2 ? (o += 0.5 * s) : (o -= 0.5 * s),
                                    m && (1 < o ? (o = 1) : o < 0 && (o = 0)),
                                    (d[u++] = { x: i, y: o });
                            for (
                                d.sort(function (e, t) {
    ...
    (function (e, t) {
        ...
        var c,
            ...
            v = 1e-8,
            y =
                ((m = (f = Object.prototype.toString).call([])),
                    function (e) {
                    ...
                    if (0 === g && a) {
                        if (((h = (p = ("com.greensock." + n).split(".")).pop()), (f = r(p.join("."))[h] = this.gsClass = a.apply(a, c)), l))
                            if (((o[h] = i[h] = f), "undefined" != typeof module && module.exports))
                                if (n === t) for (m in ((module.exports = i[t] = f), i)) f[m] = i[m];
                                else i[t] && (i[t][h] = f);
                            else
        ...
        var k = [0, 0, 1, 1],
            ...
            C = (T.register = function (e, t, i, n) {
                for (var o, s, r, a, l = t.split(","), c = l.length, d = (i || "easeIn,easeOut,easeInOut").split(","); -1 < --c;)
                    for (s = l[c], o = n ? x("easing." + s, null, !0) : g.easing[s] || {}, r = d.length; -1 < --r;) S[s + "." + (a = d[r])] = S[a + s] = o[a] = e.getRatio ? e : e[a] || new e();
            });
        for (
            ...
            (u = c[d] + ",Power" + d), C(new T(null, null, 1, d), u, "easeOut", !0), C(new T(null, null, 2, d), u, "easeIn" + (0 === d ? ",easeNone" : "")), C(new T(null, null, 3, d), u, "easeInOut");
            ...
            var i,
                ...
                g = function (e) {
                    var t,
                        n,
                        l = O() - A;
                    f < l && (d += l - m), (A += l), (c.time = (A - d) / 1e3), (t = c.time - a), (!i || 0 < t || !0 === e) && (c.frame++, (a += t + (r <= t ? 0.004 : r - t)), (n = !0)), !0 !== e && (s = o(g)), n && c.dispatchEvent("tick");
                };
            j.call(c),
                (c.time = c.frame = 0),
                (c.tick = function () {
                ...
                (c.lagSmoothing = function (e, t) {
                    return arguments.length ? void (m = Math.min(t, (f = e || 1e8), 0)) : f < 1e8;
                }),
                (c.sleep = function () {
                    null != s && ((u && E ? E : clearTimeout)(s), (o = l), (s = null), c === p && (h = !1));
                }),
                (c.wake = function (e) {
                    null !== s ? c.sleep() : e ? (d += -A + (A = O())) : 10 < c.frame && (A = O() - f + 5),
                        (o =
                            0 === i
                                ? l
                                : u && P
        ...
        I(),
            ...
            (u._enabled = function (e, t) {
                return (
                    h || p.wake(), (this._gc = !e), (this._active = this.isActive()), !0 !== t && (e && !this.timeline ? this._timeline.add(this, this._startTime - this._delay) : !e && this.timeline && this._timeline._remove(this, !0)), !1
                );
            }),
                        ...
                        (s = r[o])
                            ? "string" != typeof s
                                ? s.length && s !== e && s[0] && (s[0] === e || (s[0].nodeType && s[0].style && !s.nodeType))
                                    ...
                                    : ((this._siblings[o] = ie(s, this, !1)), 1 === c && 1 < this._siblings[o].length && ne(s, this, null, 1, this._siblings[o]))
                                : "string" == typeof (s = r[o--] = M.selector(s)) && r.splice(o + 1, 1)
                            : r.splice(o--, 1);
        ...
        function q(e, t, i, n, o, s, r, a, l) {
            ...
            var c = typeof e[t],
                ...
                h = { t: e, p: t, s: u, f: "function" == c, pg: 0, n: o || t, m: s ? ("function" == typeof s ? s : Math.round) : 0, pr: 0, c: p ? parseInt(n.charAt(0) + "1", 10) * parseFloat(n.substr(2)) : parseFloat(n) - u || 0 };
            return (
                ("number" == typeof u && ("number" == typeof n || p)) ||
                (r || isNaN(u) || (!p && isNaN(n)) || "boolean" == typeof u || "boolean" == typeof n
                    ? ((h.fp = r), (h = { t: B(u, p ? parseFloat(h.s) + h.c + (h.s + "").replace(/[0-9\-\.]/g, "") : n, a || M.defaultStringFilter, h), p: "setRatio", s: 0, c: 1, f: 2, pg: 0, n: o || t, pr: 0, m: 0 }))
        ...
        var F = [],
            ...
            N = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
            W = /[\+-]=-?[\.\d]/,
            G = (M._internals = { isArray: y, isSelector: D, lazyTweens: F, blobDif: B }),
            U = (M._plugins = {}),
            Y = (G.tweenLookup = {}),
            X = 0,
            Q = (G.reservedProps = {
        ...
        var ie = function (e, t, i) {
            var n,
                o,
                s = e._gsTweenID;
            if ((Y[s || (e._gsTweenID = s = "t" + X++)] || (Y[s] = { target: e, tweens: [] }), t && (((n = Y[s].tweens)[(o = n.length)] = t), i))) for (; -1 < --o;) n[o] === t && n.splice(o, 1);
            return Y[s].tweens;
        },
                ...
                for (s = o.length; -1 < --s;)
                    (a = o[s]) === t ||
                        ...
                        (a._timeline !== t._timeline
                            ...
                            : a._startTime <= d && a._startTime + a.totalDuration() / a._timeScale > d && (((h || !a._initted) && d - a._startTime <= 2e-8) || (u[p++] = a)));
                for (s = p; -1 < --s;)
        ...
        (u._init = function () {
            ...
            if (
                ((this._ease = d = d ? (d instanceof T ? d : "function" == typeof d ? new T(d, r.easeParams) : S[d] || M.defaultEase) : M.defaultEase),
            ...
            if ((t && M._onPluginEvent("_onInitAllProps", this), a && (this._firstPT || ("function" != typeof this.target && this._enabled(!1, !1))), r.runBackwards)) for (i = this._firstPT; i;) (i.s += i.c), (i.c = -i.c), (i = i._next);
            ...
            (u._initProps = function (t, i, n, o, s) {
                ...
                for (r in (H[t._gsTweenID] && ee(),
                    ...
                    if (((u = this.vars[r]), Q[r])) u && (u instanceof Array || (u.push && y(u))) && -1 !== u.join("").indexOf("{self}") && (this.vars[r] = u = this._swapSelfInParams(u, this));
                        ...
                        for (this._firstPT = d = { _next: this._firstPT, t: c, p: "setRatio", s: 0, c: 1, f: 1, n: r, pg: 1, pr: c._priority, m: 0 }, a = c._overwriteProps.length; -1 < --a;) i[c._overwriteProps[a]] = this._firstPT;
                ...
                return o && this._kill(o, t)
                    ...
                    : 1 < this._overwrite && this._firstPT && 1 < n.length && ne(t, this, i, this._overwrite, n)
                        ...
                        : (this._firstPT && ((!1 !== this.vars.lazy && this._duration) || (this.vars.lazy && !this._duration)) && (H[t._gsTweenID] = !0), l);
            }),
            (u.render = function (e, t, i) {
                var n,
                    o,
                ...
                if (c - v <= e && 0 <= e)
                    (a._totalTime = a._time = c),
                        ...
                        (a._startTime === a._timeline._duration && (e = 0),
                            (d < 0 || (e <= 0 && -v <= e) || (d === v && "isPause" !== a.data)) && d !== e && ((i = !0), v < d && (o = "onReverseComplete")),
                            (a._rawPrevTime = r = !t || e || d === e ? e : v));
                else if (e < v)
                    (a._totalTime = a._time = 0),
                        (a.ratio = a._ease._calcEnd ? a._ease.getRatio(0) : 0),
                        (0 !== l || (0 === c && 0 < d)) && ((o = "onReverseComplete"), (n = a._reversed)),
                        -v < e ? (e = 0) : e < 0 && ((a._active = !1), 0 === c && (a._initted || !a.vars.lazy || i) && (0 <= d && (d !== v || "isPause" !== a.data) && (i = !0), (a._rawPrevTime = r = !t || e || d === e ? e : v))),
                    ...
                    (1 === p || (3 === p && 0.5 <= u)) && (u = 1 - u),
                        ...
                        (a.ratio = 1 === p ? 1 - u : 2 === p ? u : e / c < 0.5 ? u / 2 : 1 - u / 2);
                ...
                if (a._time !== l || i) {
                    ...
                    for (
                        ...
                        0 === l && (a._startAt && (0 <= e ? a._startAt.render(e, !0, i) : (o = o || "_dummyGS")), !a.vars.onStart || (0 === a._time && 0 !== c) || t || a._callback("onStart")),
                        s = a._firstPT;
                        s;
                    ...
                    a._onUpdate && (e < 0 && a._startAt && -1e-4 !== e && a._startAt.render(e, !0, i), t || ((a._time !== l || n || i) && a._callback("onUpdate"))),
                        ...
                        (e < 0 && a._startAt && !a._onUpdate && -1e-4 !== e && a._startAt.render(e, !0, i),
                            ...
                            0 !== c || a._rawPrevTime !== v || r === v || (a._rawPrevTime = 0));
                }
            }),
            (u._kill = function (e, t, i) {
                ...
                var n,
                    ...
                    h = this._firstPT;
                if ((y(t) || D(t)) && "number" != typeof t[0]) for (n = t.length; -1 < --n;) this._kill(e, t[n], i) && (l = !0);
                else {
                    if (this._targets) {
            ...
            (M.getTweensOf = function (e, t) {
                var i, n, o, s;
                if (null == e) return [];
                if ((y((e = "string" != typeof e ? e : M.selector(e) || e)) || D(e)) && "number" != typeof e[0]) {
    ...
    (function (e) {
        ...
        (void 0 !== LS_GSAP ? LS_GSAP : window).SplitType = (function (e, t, i) {
            ...
            function r(e, t, i) {
                for (var s, r = Object(e), a = o(r) ? r : n((s = r)) && "[object Object]" === Object.prototype.toString.call(s) ? g(r) : [r], l = parseInt(a.length) || 0, c = 0; c < l; c++) t.call(i, a[c], c, r);
            }
            function a(e, t) {
                return (
                    (e = Object(e)),
            ...
            function l(e, t, o) {
                var s,
                    r = {};
                return n(e) && (r = p[(s = e[u] || (e[u] = ++h))] || (p[s] = {})), o === i ? (t === i ? r : r[t]) : t !== i ? (r[t] = o) : void 0;
            }
            function c(e, n) {
                        ...
                        (this.elements = (function (e) {
                            ...
                            if (o(e))
                                for (l = 0, r = e.length; l < r; l++)
                                    if (o(e[l])) for (c = 0, a = e[l].length; c < a; c++) s(e[l][c]) && d.push(e[l][c]);
                    ...
                    (d.prototype.split = function (t) {
                        this.revert(),
                                    ...
                                    (function (t) {
                                        ...
                                        if (
                                                    ...
                                                    .map(function (e) {
                                                        ...
                                                        if (v) {
                                                            var t = e.split("").map(function (e) {
                                                                return c(d, { class: a.charClass + " " + a.splitClass, style: "display: inline-block;", textContent: e });
                                                            });
                                                            f.apply(k, t);
                                                        }
                                                        return (
                                            ...
                                            (O = l(t).nodes = t.getElementsByTagName(d)),
                                                ...
                                                (I = e.getComputedStyle(t).textAlign),
                                                y && ((j = { left: o.offsetLeft, top: o.offsetTop, width: o.offsetWidth }), (E = t.offsetWidth), (P = t.offsetHeight), (l(t).cssWidth = t.style.width), (l(t).cssHeight = t.style.height)),
                                                r(O, function (e) {
                                                    if (e !== o) {
                                                        var t,
                                                            i = e.parentElement === o;
                                                        h && i && ((t = l(e).top = e.offsetTop) !== S && ((S = t), L.push((T = []))), T.push(e)),
                                                ...
                                                ((o = b()),
                                                    (x = L.map(function (e) {
                                                        return (
                                                            o.appendChild((i = c(d, { class: a.lineClass + " " + a.splitClass, style: "display: block; text-align:" + I + "; width: 100%;" }))),
                                                ...
                                                ((t.style.width = t.style.width || E + "px"),
                                                    ...
                                                    r(O, function (e) {
                                                        ...
                                                        (e.style.top = i ? 0 : l(e).top + "px"),
                                                            (e.style.left = t ? j.left + "px" : (i ? l(e).left - j.left : l(e).left) + "px"),
                                                            (e.style.height = l(e).height + "px"),
                                                            (e.style.width = t ? j.width + "px" : l(e).width + "px"),
                            ...
                            r(this.elements, function (e) {
                                for (var t, i, n = l(e).nodes || [], o = 0, s = n.length; o < s; o++) (i = (t = n[o]) && t[u]) && (delete t[i], delete p[i]);
                            });
                    }),
        ...
        (((t = 0),
            ...
            (i.prototype.lazyLoad = function () {
                ...
                if (
                    (!0 === s.options.centerMode
                        ...
                        : ((o = Math.ceil((n = s.options.infinite ? s.options.slidesToShow + s.currentSlide : s.currentSlide) + s.options.slidesToShow)), !0 === s.options.fade && (n > 0 && n--, o <= s.slideCount && o++)),
            ...
            (i.prototype.swipeDirection = function () {
                ...
                return (
                    ...
                    (t = Math.round((180 * Math.atan2(i.touchObject.startY - i.touchObject.curY, e)) / Math.PI)) < 0 && (t = 360 - Math.abs(t)),
